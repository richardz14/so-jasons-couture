...
vc_add_param("vc_single_image",  array(
  ...
  "value" => array(
  		...
  		'Zoom In' => 'zoom_in',
  		'Dark Overlay' => 'darken',
  		esc_html__('Title on bottom', 'qode') => 'bottom_title'
  	),
  "description" => ""
...
vc_map( array(
        ...
        array(
            ...
            array(
				...
				'save_always' => true,
                "description" => __("Select Yes if you want to use custom icon size and margin", "qode")
            ),
			array(
				"type" => "textfield",
				"holder" => "div",
				...
				"value" => "",
                "description" => __("Enter just number, omit px", "qode"),
			...
			array(
				...
				"value" => "",
				"description" => __("Enter just number, omit px. Applied only for circle or square icon type", "qode"),
				"dependency" => array('element' => 'use_custom_icon_size', 'value' => array('yes'))
			),
            array(
                "type" => "textfield",
                ...
                "value" => "",
                "description" => __("Spacing between icon and text (for left icon/margin position). Enter just number, omit px", "qode"),
                "dependency" => array('element' => "use_custom_icon_size", 'value' => array('yes'))
            ),
			array(
				"type" => "colorpicker",
...
vc_map( array(
		...
		"params" => array(
            ...
            array(
                ...
                "value" => "",
                "description" => __("Speed of slide animation in milliseconds", "qode")
            )
		)
) );
