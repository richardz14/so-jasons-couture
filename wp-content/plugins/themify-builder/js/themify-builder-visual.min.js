...
"create:element",this.createEl);this.listenTo(this.model,"visual:change",this.change_callback);this.listenTo(this.model,"custom:restorehtml",this.restoreHtml);this.listenTo(this.model,"custom:preview:live",this.previewLive);this.listenTo(this.model,"custom:preview:refresh",this.previewReload);f.vent.on("dom:preview",f.previewVisibility.bind(this))},createEl:function(d){var c=this.model.get("mod_name"),a=document.createElement("div");a.innerHTML=f.Utils.insertModuleToolbar(d,c);d=a.getElementsByClassName("module")[0];
this.el.innerHTML=d.innerHTML;d=d.attributes;this.el.className=this.attributes()["class"];for(var a=0,b=d.length;a<b;++a)if("class"===d[a].name)this.el.className+=" "+d[a].value;else{var k=d[a].name;this.el.setAttribute(k,d[a].value);0===k.indexOf("data-")&&this.$el.data(k.replace("data-",""),d[a].value)}f.VisualCache[this.model.cid]&&this.el.classList.add(f.VisualCache[this.model.cid]);"layout-part"===c&&f.Forms.LayoutPart.insertSwap(this.el)},shortcodeToHTML:function(d){function c(b){void 0!==a._shortcodeXhr&&
4!==a._shortcodeXhr&&a._shortcodeXhr.abort();a._shortcodeXhr=h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_render_element_shortcode",shortcode_data:JSON.stringify(b),tb_load_nonce:themifyBuilder.tb_load_nonce},success:function(b){if(b.success){var e=b.data.shortcodes,k=b.data.styles;if(k){b=0;for(var g=k.length;b<g;++b)Themify.LoadCss(k[b].s,k[b].v,null,k[b].m)}b=0;for(g=e.length;b<g;++b)k=Themify.hash(e[b].key),a.$el.find(".tmp"+k).replaceWith(e[b].html),l[k]=e[b].html,
Themify.is_builder_loaded&&f.Utils.loadContentJs(a.$el,"module")}}})}for(var a=this,b=[],k=!1,g=themifyBuilder.available_shortcodes,e=0,p=g.length;e<p;++e)d=wp.shortcode.replace(g[e],d,function(a){a=wp.shortcode.string(a);var e=Themify.hash(a);void 0===l[e]?(b.push(a),a='<span class="tmp'+e+'">[loading shortcode...]</span>'):a=l[e];k=!0;return a});k&&0<b.length&&c(b);return{content:d,found:k}},previewLive:function(d,c,a,b,k,g){this.is_ajax_call=!1;this._jqueryXhr&&4!==this._jqueryXhr&&this._jqueryXhr.abort();
var e=void 0!==b&&f.activeModel.cid&&k,p=300;e&&(b=this.$el.find(b),0===b.length?e=!1:g.data("control-repeater")&&(b=b.eq(g.closest(".tb_repeatable_field").index()),0===b.length&&(e=!1)));d.cid=a?a:f.activeModel.cid;if(!e||!0===c){var q=this.templateVisual(d);if(this.is_ajax_call)return;!0===c&&(d=this.shortcodeToHTML(q),d.found&&(p=1E3,q=d.content,e=!1))}if(e)b.html(k);else if(this.createEl(q),!a){f.liveStylingInstance.$liveStyledElmt=this.$el;var m=this;this.timeout&&clearTimeout(this.timeout);
this.timeout=setTimeout(function(){f.Utils.loadContentJs(m.$el,"module")},p)}},previewReload:function(d,c,a,b){function k(a){g.createEl(a);f.liveStylingInstance.$liveStyledElmt=g.$el;f.Utils.loadContentJs(g.$el,"module");g.$el.find(".tb_preview_component").remove()}if(void 0!==c&&f.activeModel.cid&&a&&(c=this.$el.find(c),0<c.length)){b.data("control-repeater")&&(c=c.eq(b.closest(".tb_repeatable_field").index()));c.html(a);return}var g=this;this._jqueryXhr&&4!==this._jqueryXhr&&this._jqueryXhr.abort();
this.is_ajax_call=!0;c=this.model.get("mod_name");a=d.unsetKey;g.el.insertAdjacentHTML("afterbegin",'<span class="tb_preview_component sp-preloader"></span>');delete d.cid;d.unsetKey;d=f.Utils.clear(d);d["module_"+c+"_slug"]=c;d=JSON.stringify(d);var e=Themify.hash(d);a&&delete n[e];if(void 0!==n[e]&&void 0!==n[e].data)d=n[e].cid,this.model.cid!==d&&(n[e].data=n[e].data.replace(new RegExp(c+"-"+d+"-"+d,"g"),c+"-"+this.model.cid+"-"+this.model.cid),n[e].cid=this.model.cid),k(n[e].data);else return n[e]=
{},this._jqueryXhr=h.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_load_module_partial",tb_post_id:this.$el.closest(".themify_builder_content").data("postid"),tb_cid:this.model.cid,tb_module_slug:c,tb_module_data:d,tb_load_nonce:themifyBuilder.tb_load_nonce},success:function(a){n[e].data=a;n[e].cid=g.model.cid;k(a)},error:function(){g.$el.removeClass("tb_preview_loading")}}),this}});f.bootstrap=function(d,c){var a=[],b=d?!0:!1,k=[];d||(d=f.Models.Registry.items);for(var g in d){var e=
f.Models.Registry.items[g],p=e.toJSON(),q=p.elType,m=p["module"===q?"mod_settings":"styling"];if(m&&0<Object.keys(m).length)!0===b&&k.push({type:"module"===q?p.mod_name:q,cid:g,data:m});else if("module"!==q){f.VisualCache[g]&&e.trigger("addClass");continue}"module"===q&&"tile"!==p.mod_name&&"ajax"!==themifyBuilder.modules[p.mod_name].type?e.trigger("custom:preview:live",p.mod_settings,"accordion"===p.mod_name||"box"===p.mod_name||"feature"===p.mod_name||"tab"===p.mod_name||"text"===p.mod_name||"plain-text"===
p.mod_name||"pointers"===p.mod_name||"pro-image"===p.mod_name||"countdown"===p.mod_name||"button"===p.mod_name||"pro-slider"===p.mod_name||"timeline"===p.mod_name,g):("column"===q?delete p.modules:"row"!==q&&"module"!==q&&"subrow"!==q||delete p.cols,a.push({jobID:g,data:p}))}!0===b&&f.liveStylingInstance.setNewRules(k);this.batch_rendering(a,0,360,c)};f.batch_rendering=function(d,c,a,b){if(c>=d.length)h.isFunction(b)&&b.call(this);else{var k=d.slice(c,c+a);this.render_element(k).done(function(){f.batch_rendering(d,
c+=a,a,b);f.toolbar.pageBreakModule.countModules()})}};f.render_element=function(d){return h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_render_element",batch:JSON.stringify(d),tb_load_nonce:themifyBuilder.tb_load_nonce,tb_post_id:themifyBuilder.post_ID},success:function(d){for(var a in d)f.Models.Registry.lookup(a).trigger("create:element",d[a])}})};f.render=function(){r(function(){for(var d=[document.getElementById("themify_builder_content-"+themifyBuilder.post_ID)],
c=0;1>c;++c){var a=d[c].dataset.postid,b=window["builderdata_"+a]?window["builderdata_"+a].data:[],b=0===b.length?{}:b.filter(function(a){return 0<Object.keys(a).length});window["builderdata_"+a]=null;f.id=a;f.Instances.Builder[c]=new f.Views.Builder({el:"#themify_builder_content-"+a,collection:new f.Collections.Rows(b),type:f.mode});f.Instances.Builder[c].render();f.bootstrap(null,function(){f.toolbar.el.style.display="block";window.top.jQuery("body").trigger("themify_builder_ready");f.Utils.loadContentJs();
top_iframe.body.insertAdjacentHTML("beforeend",themifyBuilder.data);themifyBuilder.data=null;Themify.is_builder_loaded=!0;f.vent.trigger("dom:builder:init",!0)})}f.id=!1})};Themify.body.one("builderiframeloaded.themify",function(d,c){f.iframe=h(c);setTimeout(function(){Themify.LoadCss(tbLocalScript.builder_url+"/css/animate.min.css")},1);f.toolbar=new f.Views.Toolbar({el:"#tb_toolbar"});f.toolbar.render();setTimeout(function(){f.liveStylingInstance=new w;f.liveStylingInstance.getRules()},50);setTimeout(function(){f.render()},
1);setTimeout(function(){f.Views.bindEvents()},1);f.Forms.bindEvents()});var w=function(d){function c(){this.$context=d("#tb_lightbox_parent",top_iframe);this.group=this.type=this.prefix=this.isInit=!1;this.styleName="tb_component_customize";this.style_tab="#tb_options_styling";this.generatedPrefix=[];this.generatedCache=[];this.module_rules=[];this.rulesCache=[];this.tempData=[];this.prevData=[];this.undoData=[];this.currentSheet=null;var a=this;setTimeout(function(){a.InitInlineStyles();a.initModChange();
a.before_close();a.bindLightboxForm()},1);this.bp_reverse=Object.keys(themifyBuilder.breakpoints).reverse()}c.prototype.InitInlineStyles=function(){var a='<style type="text/css" id="'+this.styleName+'-desktop"></style>',b;for(b in themifyBuilder.breakpoints)var k=f.Utils.getBPWidth(b)+"px",a=a+('<style media="screen and (max-width:'+k+')" type="text/css" id="'+this.styleName+"-"+b+'"></style>');document.body.insertAdjacentHTML("beforeend",a)};c.prototype.init=function(a){this.type=f.activeModel.get("elType");
this.$liveStyledElmt=d(".tb_element_cid_"+f.activeModel.cid);this.prefix=".themify_builder .tb_element_cid_"+f.activeModel.cid;"module"===this.type?this.group=f.activeModel.get("mod_name"):("row"!==this.type&&"sub-column"!==f.activeModel.get("component_name")&&(this.prefix=".themify_builder_content"+this.prefix),this.group=this.type);this.currentStyleObj="object"===typeof a?a:{};this.tempData=[];this.undoData=[];this.undoData[f.activeBreakPoint]=[];this.tempData[f.activeBreakPoint]=[];this.rulesCache[f.activeBreakPoint]||
(this.rulesCache[f.activeBreakPoint]=[]);this.currentSheet=this.getSheet(f.activeBreakPoint);this.isInit=!0};c.prototype.getRules=function(){var a=function(){if(themifyBuilder.debug)return!1;try{var a=localStorage.getItem("tb_rules"),b="";if(!a)return!1;var a=JSON.parse(a),e;for(e in themifyBuilder.modules)b+=e;return a.ver.toString()!==tbLocalScript.version.toString()||a.h!==Themify.hash(b)?!1:JSON.parse(a.val)}catch(p){}return!1}();if(a)this.module_rules=a;else{var b=this;d.ajax({type:"POST",url:themifyBuilder.ajaxurl,
dataType:"json",data:{action:"tb_load_rules",tb_load_nonce:themifyBuilder.tb_load_nonce},success:function(a){if(a){b.module_rules=a;try{var k="",e;for(e in themifyBuilder.modules)k+=e;var d={val:JSON.stringify(a),ver:tbLocalScript.version,h:Themify.hash(k)};localStorage.setItem("tb_rules",JSON.stringify(d))}catch(q){}}}})}};c.prototype.setNewRules=function(a){if(!f.Forms.LayoutPart.init){var b=this;return d.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{data:JSON.stringify(a),
action:"tb_set_newrules",tb_load_nonce:themifyBuilder.tb_load_nonce},success:function(a){if(a){a.fonts&&(ThemifyBuilderCommon.loadGoogleFonts(a.fonts),delete a.fonts);for(var g in a)for(var e=b.getSheet(g),k=e.cssRules?e.cssRules:e.rules,f=0,c=a[g].length;f<c;++f)a[g][f]=d.trim(a[g][f]),a[g][f]&&e.insertRule(a[g][f],k.length)}}})}};c.prototype.setLiveStyle=function(a,b,d){function g(a,b){for(var e=0,d=a.length;e<d;++e)if(b===a[e].selectorText)return e;return!1}var e;d||(d=[""]);var k="";var c=this.currentSheet.cssRules?
this.currentSheet.cssRules:this.currentSheet.rules;var m=0;for(e=d.length;m<e;++m)k+=this.prefix+d[m],m!==e-1&&(k+=",");var k=k.replace(/\s{2,}/g," ").replace(/\s*>\s*/g,">"),h=Themify.hash(k),n=b;e=void 0!==this.rulesCache[f.activeBreakPoint][h]?this.rulesCache[f.activeBreakPoint][h]:g(c,k);!1===b&&(b="");var x=a;a=function(a){if(-1!==a.indexOf("-")){var b=a.toLowerCase().split("-");a=b[0]+b[1].charAt(0).toUpperCase()+b[1].slice(1);b[2]&&(a+=b[2].charAt(0).toUpperCase()+b[2].slice(1))}return a}(a);
!1!==e&&c[e]?(void 0===this.undoData[f.activeBreakPoint][e]&&(this.undoData[f.activeBreakPoint][e]=[]),void 0===this.undoData[f.activeBreakPoint][e][a]&&(this.undoData[f.activeBreakPoint][e][a]=c[e].style[a]),c[e].style[a]=b):(e=c.length,this.currentSheet.insertRule(k+"{"+x+":"+b+";}",e),this.undoData[f.activeBreakPoint][e]=[],this.undoData[f.activeBreakPoint][e][a]=this.removeGenerated(k,a,e,f.activeBreakPoint,!1));this.rulesCache[f.activeBreakPoint][h]=e;void 0===this.tempData[f.activeBreakPoint][e]&&
(this.tempData[f.activeBreakPoint][e]=[]);this.tempData[f.activeBreakPoint][e][a]=b;if(""===n)this.removeGenerated(k,a,e,f.activeBreakPoint,!0);else{var l=e,u;for(u in this.bp_reverse){if(this.bp_reverse[u]===f.activeBreakPoint)break;m=this.bp_reverse[u];void 0===this.undoData[m]&&(this.undoData[m]=[]);void 0===this.undoData[m][l]&&(this.undoData[m][l]=[]);var v=this.removeGenerated(k,a,e,m,!0);v&&(d=this.getSheet(m),c=d.cssRules?d.cssRules:d.rules,e=void 0!==this.rulesCache[m]&&void 0!==this.rulesCache[m][h]?
this.rulesCache[m][h]:g(c,k),!1!==e&&c[e]?c[e].style[a]=b:(e=c.length,d.insertRule(k+"{"+x+":"+v+";}",e)),delete this.undoData[m][l],this.prevData[f.activeModel.cid][m][l],void 0===this.undoData[m][e]&&(this.undoData[m][e]=[]),this.undoData[m][e][a]=v,void 0===this.rulesCache[m]&&(this.rulesCache[m]=[]),void 0===this.tempData[m]&&(this.tempData[m]=[]),this.prevData[f.activeModel.cid][m][e]=[],this.prevData[f.activeModel.cid][m][e][a]=v,this.rulesCache[m][h]=e,void 0===this.tempData[m][e]&&(this.tempData[m][e]=
[]),this.tempData[m][e][a]=b)}}Themify.body.trigger("tb_"+this.type+"_styling",[this.group,a,b,n,this.$liveStyledElmt])};c.prototype.initModChange=function(){var a=this;Themify.body.on("themify_builder_change_mode",function(b,d,g){a.isInit&&(void 0===a.tempData[g]&&(a.tempData[g]=[]),void 0===a.rulesCache[g]&&(a.rulesCache[g]=[]),void 0===a.undoData[g]&&(a.undoData[g]=[]),a.currentSheet=a.getSheet(g))})};c.prototype.revertRules=function(a,b){a=a||f.activeModel.cid;var d=void 0!==this.prevData[a]?
this.prevData[a]:!1,g;for(g in this.tempData){var e=this.getSheet(g),e=e.cssRules?e.cssRules:e.rules,c;for(c in this.tempData[g])if(e[c])for(var q in this.tempData[g][c]){var m="";void 0===b&&d&&void 0!==d[g]&&void 0!==d[g][c]&&void 0!==d[g][c][q]&&(m=d[g][c][q]);e[c].style[q]=m}}this.undoData=[];this.tempData=[]};c.prototype.removeGenerated=function(a,b,d,g,e){function k(a,b,e){for(var d=0,g=a.length;d<g;++d)if(b===a[d].type)if(!1!==e&&-1!==a[d].conditionText.indexOf(e)){var f=k(a[d].cssRules?a[d].cssRules:
a[d].rules,CSSRule.STYLE_RULE,!1);if(void 0!==f)return[d,f]}else if(!1===e&&r.generatedPrefix[m][n]===a[d].selectorText.replace(/\s{2,}/g," ").replace(/\s*\,\s*/g,",").replace(/\s*>\s*/g,">"))return d}var c,m=f.activeModel.cid;e=e||!0;if(void 0!==f.VisualCache[m]){var h=this.$liveStyledElmt.closest(".themify_builder_content").data("postid");if(c=(c=null!==f.Forms.LayoutPart.el)?f.Forms.LayoutPart.el.children(".themify-builder-generated-css")[0]:document.getElementById("themify-builder-"+h+"-generated-css")){c=
c.sheet;c=c.cssRules?c.cssRules:c.rules;var n=Themify.hash(a);if(void 0===this.generatedPrefix[m]||void 0===this.generatedPrefix[m][n]){h="";if("column"===this.type&&"sub-column"!==f.activeModel.get("component_name")){var l=this.$liveStyledElmt.closest(".module_row").data("cid");void 0!==f.VisualCache[l]&&(h=f.VisualCache[l].split(" ")[1])}else"subrow"===this.type?(l=this.$liveStyledElmt.closest(".module_column"),void 0!==f.VisualCache[l.data("cid")]&&(h=f.VisualCache[l.data("cid")].split(" ")[0],
l=l.closest(".module_row").data("cid"),h=void 0!==f.VisualCache[l]?f.VisualCache[l].split(" ")[1]+" ."+h:"")):"module"===this.type&&(h="themify_builder");""!==h&&(h="."+h+" ");h=h+"."+f.VisualCache[m].replace(" ",".");l=new RegExp(this.prefix,"ig");void 0===this.generatedPrefix[m]&&(this.generatedPrefix[m]=[]);this.generatedPrefix[m][n]=a.replace(l,h).replace(/\s{2,}/g," ").replace(/\s*\,\s*/g,",").replace(/\s*>\s*/g,">")}}else{delete f.VisualCache[m];this.generatedPrefix[m];return}}var r=this;a=
"";if(void 0!==this.generatedPrefix[m]&&void 0!==this.generatedPrefix[m][n]){void 0===this.generatedCache[g]&&(this.generatedCache[g]=[]);l=CSSRule.STYLE_RULE;var u=Themify.hash(this.generatedPrefix[m][n]);h=this.generatedCache[g][u];var v=!1;void 0===h&&("desktop"!==g&&(v=f.Utils.getBPWidth(g)+"px",l=CSSRule.MEDIA_RULE),this.generatedCache[g][u]=k(c,l,v),h=this.generatedCache[g][u]);void 0!==h&&(void 0!==h[1]?(c=c[h[0]].cssRules?c[h[0]].cssRules:c[h[0]].rules,a=c[h[1]].style[b],e&&(c[h[1]].style[b]=
"")):"desktop"===g&&(a=c[h].style[b],e&&(c[h].style[b]="")),e&&""!==a&&(void 0===this.prevData[m]&&(this.prevData[m]=[]),void 0===this.prevData[m][g]&&(this.prevData[m][g]=[]),void 0===this.prevData[m][g][d]&&(this.prevData[m][g][d]=[]),this.prevData[m][g][d][b]=a,""===this.undoData[g][d][b]&&(this.undoData[g][d][b]=a)))}return a};c.prototype.remember=function(a){this.prevData[a]=d.extend(!0,{},this.tempData)};c.prototype.getRememberedStyles=function(){return this.tempData};c.prototype.getSheet=function(a){return document.getElementById(this.styleName+
"-"+a).sheet};c.prototype.reset=function(){var a=Object.keys(themifyBuilder.breakpoints);a.push("desktop");for(var b in a)d("link#"+this.styleName+"-"+b).remove();this.InitInlineStyles();this.rulesCache=[];this.tempData=[];this.prevData=[];this.generatedPrefix=[];this.generatedCache=[]};c.prototype.doUndo=function(a,b){for(var d in a){var g=this.getSheet(d),g=g.cssRules?g.cssRules:g.rules,e;for(e in a[d])if(g[e])for(var f in a[d][e])g[e].style[f]=b||""===a[d][e][f]?"":"backgroundImage"===f&&-1===
a[d][e][f].indexOf("(",2)?"url("+a[d][e][f]+")":a[d][e][f]}};c.prototype.before_close=function(){var a=this;Themify.body.on("themify_builder_lightbox_before_close",function(){a.isInit=!1;if(null!==f.activeModel&&(a.$liveStyledElmt.removeClass("animated hover-wow"),!f.saving&&f.hasChanged&&(a.revertRules(),a.type&&"module"!==a.type))){var b=f.activeModel.get("styling");b&&"slider"===b.background_type&&b.background_slider&&a.bindBackgroundSlider()}})};c.prototype.bindColors=function(){var a=this;Themify.body.on("themify_builder_color_picker_change",
function(b,d,g,e){a.isInit&&("cover_color"===d||"cover_color_hover"===d?a.addOrRemoveComponentOverlay(d,e):g.hasClass("tb_frame")?a.addOrRemoveFrame(g):g.hasClass("border_color")?a.bindMultiFields(g):(b=a.getValue(d))&&a.setLiveStyle(b.prop,e,b.selector))})};c.prototype.addOrRemoveFrame=function(a){var b=this,k=f.liveStylingInstance.$liveStyledElmt,g=f.liveStylingInstance.$context.find(b.style_tab),e=a.closest(".tb_tab").attr("id").match(/frame_tabs_(.*)$/)[1],c={},h=this.getValue(e+"-frame_type").selector;
a=k.children(".tb_row_frame_"+e);d("custom location width height width_unit height_unit repeat".split(" ")).each(function(a,b){c[b]=d("#"+e+"-frame_"+b,g).val()});c.type=d("#"+e+"-frame_type :checked",g).val();c.layout=d("#"+e+"-frame_layout",g).find("a.selected").attr("id");c.color=d("#"+e+"-frame_color",g).val()?d("#"+e+"-frame_color",g).minicolors("rgbaString"):"";c.type===e+"-presets"&&""===c.layout||c.type===e+"-custom"&&""===c.custom?a.remove():(1>a.length?(a=d("<div />",{"class":"tb_row_frame tb_row_frame_"+
e+" "+c.location}),k.children(".tb_action_wrap").after(a)):a.removeClass("behind_content in_front").addClass(c.location),c.type===e+"-presets"?d.ajax({dataType:"text",url:tbLocalScript.builder_url+"/img/row-frame/"+("left"===e||"right"===e?c.layout+"-l":c.layout)+".svg",success:function(a){c.color&&(a=a.replace(/\#D3D3D3/gi,c.color));b.setLiveStyle("background-image",'url("data:image/svg+xml;base64,'+btoa(a)+'")',h)}}):b.setLiveStyle("background-image",'url("'+c.custom+'")',h),b.setLiveStyle("width",
c.width?c.width+c.width_unit:"",h),b.setLiveStyle("height",c.height?c.height+c.height_unit:"",h),c.repeat?"left"===e||"right"===e?b.setLiveStyle("background-size","100% "+100/c.repeat+"%",h):b.setLiveStyle("background-size",100/c.repeat+"% 100%",h):b.setLiveStyle("background-size","",h))};c.prototype.overlayType=function(a,d){var b="color"===d||"hover_color"===d;a=b?a.replace("-type",""):"cover_color_hover-type"===a?"cover_gradient_"+d.replace("_","-")+"-type":a.replace("color","gradient-gradient");
var g=this.$context.find("#"+a);if(b){if(b=g.val())if(g.data("minicolors-initialized"))b=g.minicolors("rgbaString");else{var e=g.data("opacity");""!==e&&void 0!==e&&"1"!=e&&"0.99"!=e&&(b=f.Utils.toRGBA(b+"_"+e))}Themify.body.trigger("themify_builder_color_picker_change",[a,g,b])}else g.trigger("change")};c.prototype.bindBackgroundGradient=function(a,d){if(this.isInit){var b=this.getValue(a);b&&("cover_gradient"!==a&&"cover_gradient_hover"!==a||this.setLiveStyle("background-color",!1,b.selector),this.setLiveStyle(b.prop,
d,b.selector))}};c.prototype.addOrRemoveComponentOverlay=function(a,b){var c=this.getComponentBgOverlay(),g=0!==c.length;g||(c=d("<div/>",{"class":"builder_row_cover"}));if("cover_gradient"!==a&&"cover_gradient_hover"!==a){var e=this.getValue(a);this.setLiveStyle("background-image","none",e.selector);this.setLiveStyle(e.prop,b,e.selector)}else this.bindBackgroundGradient(a,b);g||f.liveStylingInstance.$liveStyledElmt.children(".tb_action_wrap").before(c)};c.prototype.bindMultiFields=function(a,b){function c(a,
b){if(!n){if("row"===h.type&&""===tbLocalScript.fullwidth_support&&(r&&("padding"===b||"margin"===b)||"padding-left"===b||"padding-right"===b||"margin-left"===b||"margin-right"===b)){var e=b.split("-"),g=f.activeBreakPoint+"-"+e[0];if(r)a=a+","+a;else{var c=h.$liveStyledElmt.data(g),c=c?c.split(","):[];"left"===e[1]?c[0]=a:c[1]=a;a=c.join(",")}h.$liveStyledElmt.attr("data-"+g,a).data(g,a);ThemifyBuilderModuleJs.setupFullwidthRows(h.$liveStyledElmt)}(r&&"padding"===b||0===b.indexOf("padding"))&&setTimeout(function(){d(window).trigger("tfsmartresize.tfVideo")},
600)}}function g(a){var b=d.trim(a.val());""!==b&&(b=parseFloat(b),isNaN(b)?b="":0!==b&&(b+=h.$context.find("#"+a.prop("id")+"_unit").val()));return b}function e(a){var b=a.closest("li");a=parseFloat(d.trim(b.find(".border_width").val()));var e=b.find(".border_style").val(),b=b.find(".minicolors-input"),c=d.trim(b.val()),b=c&&b.data("minicolors-initialized")?b.minicolors("rgbaString"):c;"none"===e?a=e:isNaN(a)||""===a||""===b?a="":(-1===b.indexOf("rgb")&&-1===b.indexOf("#")&&(b="#"+b),a=a+"px "+e+
" "+b);return a}var h=this;var q=a.prop("id");var m=h.getValue(q);if(m){q=a.closest(".tb_seperate_items");var l=m.prop.split("-")[0];var n=q.hasClass("tb_borders");var r="1"===q.attr("data-checked");if(r){var t=n?e(a):g(a);h.setLiveStyle(l,t,m.selector);c(t,l)}else b?(h.setLiveStyle(l,"",m.selector),q.find(".tb_multi_field").each(function(){t=n?e(d(this)):g(d(this));var a=h.getValue(d(this).prop("id")).prop;h.setLiveStyle(a,t,m.selector);c(t,a)})):(t=n?e(a):g(a),h.setLiveStyle(m.prop,t,m.selector),
c(t,m.prop))}};c.prototype.bindRowWidthHeight=function(){var a=this;Themify.body.on("tb_row_height",function(b,c){"fullheight"===c?a.$liveStyledElmt.addClass(c):a.$liveStyledElmt.removeClass("fullheight");d(window).trigger("tfsmartresize.tfVideo")}).on("tb_row_width",function(b,c){"fullwidth"===c?(a.$liveStyledElmt.removeClass("fullwidth").addClass("fullwidth_row_container"),ThemifyBuilderModuleJs.setupFullwidthRows(a.$liveStyledElmt)):"fullwidth-content"===c?(a.$liveStyledElmt.removeClass("fullwidth_row_container").addClass("fullwidth"),
ThemifyBuilderModuleJs.setupFullwidthRows(a.$liveStyledElmt)):a.$liveStyledElmt.removeClass("fullwidth fullwidth_row_container").css({"margin-left":"","margin-right":"","padding-left":"","padding-right":"",width:""});d(window).trigger("tfsmartresize.tfVideo")})};c.prototype.bindParralax=function(){var a=this;this.$context.on("keyup","#custom_parallax_scroll_zindex",function(){var b=parseInt(d(this).val());isNaN(b)&&(b="");a.$liveStyledElmt[0].style.zIndex=b})};c.prototype.bindAnimation=function(){var a=
this;this.$context.on("change","#animation_effect,#animation_effect_delay,#animation_effect_repeat,#hover_animation_effect",function(){var b="hover_animation_effect"===d(this).prop("id"),c=b?"hover_animation_effect":"animation_effect",g=b?d(this).val():a.$context.find("#animation_effect").val(),e=a.getStylingVal(c);e&&(b&&(e=e+" hover-wow hover-animation-"+e),a.$liveStyledElmt.removeClass(e+" wow animated").css({"animation-name":"","animation-delay":"","animation-iteration-count":""}));a.setStylingVal(c,
g);g&&(b?g="hover-wow hover-animation-"+g:(c=parseFloat(a.$context.find("#animation_effect_delay").val()),e=parseInt(a.$context.find("#animation_effect_repeat").val()),a.$liveStyledElmt.css({"animation-delay":0<c&&!isNaN(c)?c+"s":"","animation-iteration-count":0<e&&!isNaN(e)?e:""})),setTimeout(function(){a.$liveStyledElmt.addClass(g+" animated");b&&a.$liveStyledElmt.trigger("mouseover")},1))})};c.prototype.bindAdditionalCSSClass=function(){var a=this;this.$context.on("keyup","#custom_css_row, #custom_css_column",
function(){var b=this.id,c=a.getStylingVal(b);a.$liveStyledElmt.removeClass(c);c=d(this).val();a.setStylingVal(b,c);a.$liveStyledElmt.addClass(c)})};c.prototype.getRowAnchorClass=function(a){return 0<a.length?"tb_section-"+a:""};c.prototype.getStylingVal=function(a){return void 0!==this.currentStyleObj[a]?this.currentStyleObj[a]:""};c.prototype.setStylingVal=function(a,b){this.currentStyleObj[a]=b};c.prototype.bindBackgroundMode=function(a,b){var d=this.getValue(b);if(0<a.length){var c={repeat:"repeat",
