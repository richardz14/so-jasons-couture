var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(e,v,A){e instanceof String&&(e=String(e));for(var B=e.length,b=0;b<B;b++){var F=e[b];if(v.call(A,F,b,e))return{i:b,v:F}}return{i:-1,v:void 0}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(e,v,A){e!=Array.prototype&&e!=Object.prototype&&(e[v]=A.value)};$jscomp.getGlobal=function(e){return"undefined"!=typeof window&&window===e?e:"undefined"!=typeof global&&null!=global?global:e};
$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(e,v,A,B){if(v){A=$jscomp.global;e=e.split(".");for(B=0;B<e.length-1;B++){var b=e[B];b in A||(A[b]={});A=A[b]}e=e[e.length-1];B=A[e];v=v(B);v!=B&&null!=v&&$jscomp.defineProperty(A,e,{configurable:!0,writable:!0,value:v})}};$jscomp.polyfill("Array.prototype.find",function(e){return e?e:function(e,A){return $jscomp.findInternal(this,e,A).v}},"es6-impl","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.symbolCounter_=0;$jscomp.Symbol=function(e){return $jscomp.SYMBOL_PREFIX+(e||"")+$jscomp.symbolCounter_++};
$jscomp.initSymbolIterator=function(){$jscomp.initSymbol();var e=$jscomp.global.Symbol.iterator;e||(e=$jscomp.global.Symbol.iterator=$jscomp.global.Symbol("iterator"));"function"!=typeof Array.prototype[e]&&$jscomp.defineProperty(Array.prototype,e,{configurable:!0,writable:!0,value:function(){return $jscomp.arrayIterator(this)}});$jscomp.initSymbolIterator=function(){}};$jscomp.arrayIterator=function(e){var v=0;return $jscomp.iteratorPrototype(function(){return v<e.length?{done:!1,value:e[v++]}:{done:!0}})};
$jscomp.iteratorPrototype=function(e){$jscomp.initSymbolIterator();e={next:e};e[$jscomp.global.Symbol.iterator]=function(){return this};return e};$jscomp.iteratorFromArray=function(e,v){$jscomp.initSymbolIterator();e instanceof String&&(e+="");var A=0,B={next:function(){if(A<e.length){var b=A++;return{value:v(b,e[b]),done:!1}}B.next=function(){return{done:!0,value:void 0}};return B.next()}};B[Symbol.iterator]=function(){return B};return B};
...
(function(e){function v(){function a(a){var b="";if("string"===typeof a)b=a;else for(var c in a)b+=a[c];document.body.insertAdjacentHTML("beforeend",b)}var b=function(){if(themifyBuilder.debug)return!1;try{var a=localStorage.getItem("tb_form_templates"),b="";if(!a)return!1;var a=JSON.parse(a),c;for(c in themifyBuilder.modules)b+=c;return a.ver.toString()!==tbLocalScript.version.toString()||a.h!==Themify.hash(b)?!1:a.val}catch(h){}return!1}();b?a(b):e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_load_form_templates",
tb_load_nonce:themifyBuilder.tb_load_nonce},success:function(b){if(b){a(b);b=b.replace(/\s\s+/g," ");try{var c="",d;for(d in themifyBuilder.modules)c+=d;var e={val:b,ver:tbLocalScript.version,h:Themify.hash(c)};localStorage.setItem("tb_form_templates",JSON.stringify(e))}catch(k){}}}})}"function"===typeof window.top.document.ondragstart&&(window.top.document.ondragstart=null,window.document.ondragstart=null);var A=e.ui.sortable.prototype._mouseStart,B=document.body.classList.contains("full-section-scrolling");
e.ui.sortable.prototype._mouseStart=function(a,b,d){"mousedown"===a.type&&this._trigger("beforeStart",a,[this,this._uiHash()]);A.apply(this,[a,b,d])};void 0===e.fn.themifySerializeObject&&(e.fn.themifySerializeObject=function(){for(var a={},b=0,d=this.length;b<d;++b){var f=this[b].type;if(this[b].classList.contains("wp-editor-area")&&void 0!==tinyMCE){var g=tinyMCE.get(this[b].id);g&&(this[b].value=g.getContent())}if(""!==this[b].value&&this[b].name&&("text"===f||"number"===f||"radio"===f||"checkbox"===
...
cache:{repeaterElements:{}}},F=[];b.mode="default";b.autoSaveCid=null;b.hasChanged=null;b.editing=!1;b.init=!1;b.scrollTo=!1;b.eventName=!1;b.beforeEvent=!1;b.saving=!1;b.activeBreakPoint="desktop";b.zoomMeta={isActive:!1,size:100};b.isPreview=!1;b.Models.Module=Backbone.Model.extend({defaults:{element_id:null,elType:"module",mod_name:"",mod_settings:{}},initialize:function(){b.Models.Registry.register(this.cid,this);this.get("element_id")||this.set({element_id:b.Utils.generateUniqueID()},{silent:!0})},
...
b.Views.init_module(a);a.model.trigger("custom:change",a)},backendLivePreview:function(){e(".tb_element_cid_"+this.cid).find(".module_excerpt").text(this.getExcerpt(F))},getPreviewSettings:function(){return _.extend({cid:this.cid},themifyBuilder.modules[this.get("mod_name")].defaults,F)},getIDattr:function(){return this.get("element_id")?this.get("element_id"):b.Utils.generateUniqueID()}});b.Models.SubRow=Backbone.Model.extend({defaults:{element_id:null,elType:"subrow",row_order:0,gutter:"gutter-default",
...
b.Views.unregister_row=function(){"default"!==b.mode&&(this.Rows[b.mode]=null,delete this.Rows[b.mode])};b.Views.row_exists=function(){return this.Rows.hasOwnProperty(b.mode)};b.Views.BaseElement=Backbone.View.extend({type:"default",events:{"click .tb_copy_component":"copy","click .tb_paste_component":"paste","click .tb_import_component":"import","click .tb_export_component":"export","click .tb_save_component":"save","click .tb_duplicate":"duplicate","click .tb_delete":"delete"},initialize:function(a){_.extend(this,
...
b.vent.trigger("dom:builder:change"))},remove:function(){this.$el.remove()},copy:function(a){a.preventDefault();a.stopPropagation();var c=e(a.currentTarget).closest("[data-cid]"),d=b.Models.Registry.lookup(c.data("cid"));d&&(a=d.get("elType"),"column"===a&&(a=d.get("component_name")),c=this.getData(c,a),"sub-column"===a&&(c.component_name=a),ThemifyBuilderCommon.Clipboard.set(a,c))},paste:function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget).closest("[data-cid]");var c=b.Models.Registry.lookup(a.data("cid"));
if(c){var d=c.get("elType");"column"===d&&(d=c.get("component_name"));var f=ThemifyBuilderCommon.Clipboard.get(d);if(!1===f)ThemifyBuilderCommon.alertWrongPaste();else if(ThemifyBuilderCommon.confirmDataPaste()){b.eventName="row";if("column"===d||"sub-column"===d)f.grid_class=b.Utils.filterClass(a.prop("class")),a.hasClass("first")?f.grid_class+=" first":a.hasClass("last")&&(f.grid_class+=" last"),d=a[0].style.width,f.grid_width=d?d.replace("%",""):null;b.beforeEvent=ThemifyBuilderCommon.clone(a);
b.hasChanged=!0;c.setData(f)}}},"import":function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget);var c=ThemifyBuilderCommon.detectBuilderComponent(a),d=a.closest("[data-cid]"),f=b.Models.Registry.lookup(d.data("cid")),g={data:{action:"tb_component_data",component:c,type:"import"}};if("column"===c||"sub-column"===c){var h=a.closest(".module_column");var k=h.closest("column"===c?".module_row":".module_subrow").index();g.data.indexData={row:k,col:h.index()}}ThemifyBuilderCommon.Lightbox.open(g,
null,function(){var a=this.$lightbox;a.find("#builder_submit_import_component_form").on("click",function(g){g.preventDefault();g=a.find("#tb_data_field");g=JSON.parse(g.val());if("column"===c&&"sub-column"===g.component_name||"sub-column"===c&&"column"===g.component_name)g.component_name=c;if(void 0===g.component_name||g.component_name!==c)ThemifyBuilderCommon.alertWrongPaste();else{g=b.Utils.clear(g,!0);if("column"===c||"sub-column"===c)g.column_order=h.index(),g.grid_class=h.prop("class"),"column"===
c?g.row_order=k:(g.sub_row_order=k,g.row_order=h.closest(".module_row").index(),g.col_order=h.parents(".module_column").index());b.eventName="row";b.beforeEvent=ThemifyBuilderCommon.clone(d);b.hasChanged=!0;f.setData(g);ThemifyBuilderCommon.Lightbox.close()}})})},getData:function(a,c){var d={};var f=c||ThemifyBuilderCommon.detectBuilderComponent(a);switch(f){case "row":case "subrow":var g=a.closest(".module_"+f);var e=g.index();d=b.Utils._getRowSettings(g[0],e,f);break;case "module":d=b.Models.Registry.lookup(a.closest(".active_module").data("cid")).attributes;
d=b.Utils.clear(d,!0);break;case "column":case "sub-column":d=a.closest(".module_column"),g=d.closest("column"===f?".module_row":".module_subrow"),e=g.index(),f=b.Utils._getRowSettings(g[0],e,"column"===f?"row":"subrow"),d=f.cols[d.index()]}return d},"export":function(a){a.preventDefault();a.stopPropagation();var b=e(a.currentTarget);a=ThemifyBuilderCommon.detectBuilderComponent(b);var d=this.getData(b,a),b={data:{action:"tb_component_data",component:a,type:"export"}};d.component_name=a;d=JSON.stringify(d);
ThemifyBuilderCommon.Lightbox.open(b,null,function(){this.$lightbox.find("#tb_data_field").val(d).on("click",function(){e(this).trigger("focus").trigger("select")})})},duplicate:function(a){a.preventDefault();a.stopPropagation();a=e(a.currentTarget).closest("[data-cid]");var c=ThemifyBuilderCommon.clone(a),d=b.Models.Registry.lookup(c.data("cid"));a.removeClass("tb_element_cid_"+d.cid);c.hide().insertAfter(a);var f="module"===d.get("elType")?"mod_settings":"styling",g=this.getData(c,d.get("elType"));
if(b.activeModel&&b.activeModel.cid===d.cid&&ThemifyBuilderCommon.Lightbox.$lightbox.is(":visible")){var h=b.Forms.serialize("tb_options_setting"),k=b.Forms.serialize("tb_options_animation"),l=b.Forms.serialize("tb_options_visibility"),m=e.extend(!0,{},b.Mixins.Common.styleData),m=b.Forms.serialize("tb_options_styling",m),m=b.Utils.clear(m,!0),h=e.extend(!0,m,h,k,l),h=b.Utils.clear(h);g[f]=h}b.eventName="duplicate";b.beforeEvent=c;b.hasChanged=!0;d.setData(g);a.addClass("tb_element_cid_"+d.cid)},
editComponent:function(){b.hasChanged=!1;var a=b.activeModel.get("elType"),c=ThemifyBuilderCommon.Lightbox.$lightbox;if(b.autoSaveCid===b.activeModel.cid)b.activeModel.get("styleClicked")?(c.find('a[href="#tb_options_styling"]').trigger("click"),b.activeModel.unset("styleClicked",{silent:!0})):b.activeModel.get("visibileClicked")?(c.find('a[href="#tb_options_visibility"]').trigger("click"),b.activeModel.unset("visibileClicked",{silent:!0})):"module"!==a&&"row"!==a||c.find('a[href="#tb_options_setting"]').trigger("click");
else{var d="module"===a?b.activeModel.get("mod_name"):a;ThemifyBuilderCommon.Lightbox.open({loadMethod:"inline",templateID:"builder_form_"+d},function(c){b.Mixins.Common.editComponentCallback(c,a,!1,!1)},function(d){b.activeModel.get("styleClicked")?c.find('a[href="#tb_options_styling"]').trigger("click"):b.activeModel.get("visibileClicked")?c.find('a[href="#tb_options_visibility"]').trigger("click"):new SimpleBar(c.find("#"+("column"===a||"subrow"===a?"tb_options_styling":"tb_options_setting"))[0]);
b.autoSaveCid=b.activeModel.cid;setTimeout(function(){b.activeModel.unset("styleClicked",{silent:!0});b.activeModel.unset("visibileClicked",{silent:!0})},500)})}},"delete":function(a){var c;a.preventDefault();a.stopPropagation();a=e(a.currentTarget).closest("[data-cid]");var d=a.data("cid"),f=b.Models.Registry.lookup(d);if(f){var g=f.get("elType");if(confirm(themifyBuilder.i18n[g+"DeleteConfirm"])){var h=a.closest(".module_row"),k="row",l="",m={};"row"===g?(m.pos_cid=h.next(".module_row"),m.pos="before",
0===m.pos_cid.length&&(m.pos="after",m.pos_cid=h.prev(".module_row")),k="delete_row",m.pos_cid=m.pos_cid.data("cid")):d=h.data("cid");h=ThemifyBuilderCommon.clone(h);"row"!==g&&(c=a.closest(".module_subrow"));f.destroy();"row"!==g&&0<c.length&&0===c.find(".active_module").length&&c.addClass("tb_row_empty");"row"!==g?(l=e(".tb_element_cid_"+d),c=l.closest(".module_row"),0===c.find(".active_module").length&&c.addClass("tb_row_empty")):b.vent.trigger("dom:builder:change");b.hasChanged=!0;b.undoManager.push(d,
h,l,k,m);b.toolbar.pageBreakModule.countModules()}}},save:function(a){a.preventDefault();a.stopPropagation();a={data:{action:"tb_library_item_form",postid:themifyBuilder.post_ID,model:this.model.cid,type:ThemifyBuilderCommon.detectBuilderComponent(e(a.currentTarget))}};ThemifyBuilderCommon.Lightbox.open(a)}});b.Views.BaseElement.extend=function(a){var b=this,d=Backbone.View.extend.apply(this,arguments);d.prototype.events=_.extend({},this.prototype.events,a.events);d.prototype.initialize=function(){_.isFunction(b.prototype.initialize)&&
b.prototype.initialize.apply(this,arguments);_.isFunction(a.initialize)&&a.initialize.apply(this,arguments)};return d};b.Views.Modules["default"]=b.Views.BaseElement.extend({tagName:"div",attributes:function(){return{"class":"tb_module module-"+this.model.get("mod_name")+" active_module tb_element_cid_"+this.model.cid,"data-cid":this.model.cid}},template:"visual"===b.mode?null:wp.template("builder_module_item"),events:{dblclick:"edit","click .themify_module_options":"edit","click .tb_module_styling":"edit",
...
"click .tb_visibility_component ":"edit","click .tb_grid_list li a":"_gridClicked","click .grid_tabs li a":"_switchGridTabs","click .tb_column_alignment li a":"_columnAlignmentClicked","click .tb_column_direction li a":"_columnDirectionClicked","change .gutter_select":"_gutterChange"},initialize:function(){this.listenTo(this.model,"change:view",this.setView)},render:function(a,c){var d=this.model.get("cols"),f=Object.keys(d).length;this.el.innerHTML=ThemifyBuilderCommon.templateCache.get("tmpl-builder_row_item");
if(0<f){for(var g=document.createDocumentFragment(),e,k=!1,l=!1,m=!1,n=0;n<=f;++n)if(void 0!==d[n]){d[n].component_name="column";var p=b.Views.init_column(d[n]);b.id&&(e=p.model.get("column_order"),void 0===e&&(e=n),k=a+"-"+e,l=c+"-"+e);b.id&&(b.VisualCache[p.model.cid]="module_column_"+e+" tb_"+b.id+"_column");g.appendChild(p.view.render(k,l).el);!1===m&&void 0!==d[n].modules&&0<d[n].modules.length&&(m=!0)}!1===m&&this.el.classList.add("tb_row_empty");this.el.getElementsByClassName("row_inner")[0].appendChild(g)}else this.el.classList.add("tb_row_empty"),
b.Utils._addNewColumn({newclass:"col-full",component:"column"},this.el.getElementsByClassName("row_inner")[0]);b.Utils.selectedGridMenu(this.el);return this},edit:function(a){a.stopPropagation();a.preventDefault();b.activeModel&&b.activeModel.cid===this.model.get("cid")||(a.currentTarget.classList.contains("tb_style_row")?this.model.set({styleClicked:!0},{silent:!0}):a.currentTarget.classList.contains("tb_visibility_component")&&this.model.set({visibileClicked:!0},{silent:!0}),this.model.cid!==b.autoSaveCid&&
null!==b.autoSaveCid&&b.Forms.saveComponent(null),b.activeModel=this.model,this.editComponent())},_switchGridTabs:function(a){b.scrollTo=e(a.currentTarget).closest("[data-cid]");b.Forms.lightbox_switcher(a)},_gridClicked:function(a){a.preventDefault();a=e(a.currentTarget);var c=a.data("grid"),d=a.data("handle"),f=!1,g=a.data("type"),h=a.parent(),k="desktop"===g;if(!h.hasClass("selected")){var l=ThemifyBuilderCommon.clone(a.closest(".module_row"));h.addClass("selected").siblings().removeClass("selected");
if("module"===d){if("-full"!==c[0]){f=!0;var m=b.Views.init_subrow({cols:[{grid_class:"col-full"}]});var h=a.closest(".active_module"),n=h.clone();n.insertAfter(h);var p=m.view.render().$el.find(".tb_holder").prepend(h).end().insertAfter(n).find("."+a.prop("class").replace(" ",".")).closest("li").addClass("selected").siblings().removeClass("selected").end().end().end().find(".subrow_inner");n.remove();m=p.closest(".module_subrow")}}else f="subrow"===d,m=a.closest(".module_"+d),p=m.find("."+d+"_inner").first();
if(0!==p.length){if(k||"module"===d){g=p;var r=a.data("col");g=g.add(m);void 0===r&&(r=1,a.data("col",r));g.removeClass("col-count-1 col-count-"+p.attr("data-basecol")).addClass("col-count-"+r);p.attr("data-basecol",r);k&&a.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=e(this).find(".selected"),b=a.find("a"),c=b.data("type"),b=b.data("col");void 0!==b&&(b>r||4===r&&3===b||4<=r&&4<=b&&r!=b)&&(a.removeClass("selected"),p.removeClass("tb_grid_classes col-count-"+
p.attr("data-basecol")+" "+p.attr("data-col_"+c)).attr("data-col_"+c,""),e(this).closest(".tb_grid_list").find("."+c+"-auto").parent().addClass("selected"))})}else return"-auto"!==c[0]?(l="column"+c.join("-"),r=a.data("col"),3===r&&p.attr("data-basecol")>r&&(l+=" tb_3col"),p.removeClass(p.attr("data-col_tablet")+" "+p.attr("data-col_tablet_landscape")+" "+p.attr("data-col_mobile")).addClass(l+" tb_grid_classes col-count-"+p.attr("data-basecol")).attr("data-col_"+g,l)):p.removeClass("tb_grid_classes tb_3col col-count-"+
p.attr("data-basecol")+" "+p.attr("data-col_"+g)).attr("data-col_"+g,""),"visual"===b.mode&&e("body",top_iframe).height(document.body.scrollHeight),b.Utils.setCompactMode(p.children(".module_column")),!1;g=p.children(".module_column");k=c.length;d="module_column"+(f?" sub_column":"")+" col";for(m=0;m<k;++m)h=g.eq(m),0<h.length?h.removeClass(b.Utils.gridClass.join(" ")).addClass(d+c[m]):b.Utils._addNewColumn({newclass:d+c[m],component:f?"sub-column":"column"},p[0]);k<p.children().length&&p.children(".module_column").eq(k-
1).nextAll().each(function(){e(this).find(".tb_holder").first().children().appendTo(e(this).prev().find(".tb_holder").first());e(this).remove()});g=p.children();g.removeClass("first last");p.hasClass("direction-rtl")?(g.last().addClass("first"),g.first().addClass("last")):(g.first().addClass("first"),g.last().addClass("last"));f&&"-full"===c[0]&&(c=p.closest(".module_subrow"),f=p.find(".active_module"),f.insertAfter(c),c.remove(),f.find(".tb_grid_list .grid-layout--full").parent().addClass("selected").siblings().removeClass("selected"));
b.Utils.columnDrag(p,!0);m=a.closest(".module_row");b.hasChanged=!0;b.Mixins.Builder.updateModuleSort(m);b.undoManager.push(m.data("cid"),l,m,"row");Themify.body.trigger("tb_grid_changed",[m])}}},_columnAlignmentClicked:function(a){a.preventDefault();a=e(a.currentTarget);var c=a.data("handle");if("module"!==c&&!a.closest("li").hasClass("selected")){a.closest("li").addClass("selected").siblings("li").removeClass("selected");var d=a.closest(".module_"+c);var f=a.data("alignment"),g=b.Models.Registry.lookup(d.data("cid")),
h=ThemifyBuilderCommon.clone(d);d.find("."+c+"_inner").first().removeClass(g.get("column_alignment")).addClass(f);g.set({column_alignment:f},{silent:!0});b.undoManager.push(h.data("cid"),h,a.closest(".module_"+c),"row")}},_columnDirectionClicked:function(a){a.preventDefault();var c=e(a.currentTarget),d=c.data("handle");a=c.data("dir");if("module"!==d&&!c.closest("li").hasClass("selected")){c.closest("li").addClass("selected").siblings("li").removeClass("selected");var c=c.closest(".module_"+d),d=
c.find("."+d+"_inner").first(),f=d.children(".module_column"),c=f.first(),f=f.last();"rtl"===a?(c.removeClass("first").addClass("last"),f.removeClass("last").addClass("first"),d.addClass("direction-rtl")):(c.removeClass("last").addClass("first"),f.removeClass("first").addClass("last"),d.removeClass("direction-rtl"));d.attr("data-"+b.activeBreakPoint+"_dir",a)}},_gutterChange:function(a){a=e(a.currentTarget);var c=a.data("handle");if("module"!==c){var d=a.val();a.find("option").removeAttr("selected").filter('[value="'+
d+'"]').attr("selected","selected");var f=a.closest(".module_"+c),g=ThemifyBuilderCommon.clone(f),h=f.find("."+c+"_inner").first(),k=b.Models.Registry.lookup(f.data("cid"));g.find(".tb_action_wrap .gutter_select").val(f.data("gutter"));b.Utils.columnDrag(h,!1,k.get("gutter"),d);h.removeClass(k.get("gutter")).addClass(d);k.set({gutter:d},{silent:!0});b.undoManager.push(g.data("cid"),g,a.closest(".module_"+c),"row")}},setView:function(a){this.setElement(a)}});b.Views.Builder=Backbone.View.extend({type:"default",
events:{"click .tb_import_layout_button":"importLayoutButton"},initialize:function(a){_.extend(this,_.pick(a,"type"));b.vent.on("dom:builder:change",this.newRowAvailable.bind(this));b.vent.on("dom:builder:init",this.init.bind(this))},init:function(a){b.init=a;this.rowSort();"visual"===b.mode?(b.Mixins.Builder.updateModuleSort(this.$el),a&&(this.initModuleVisualDrag(".tb_module"),this.initRowGridVisualDrag()),setTimeout(function(){b.Utils._onResize(!0)},1500)):(b.Mixins.Builder.updateModuleSort(this.$el),
a&&(b.Mixins.Builder.initModuleDraggable(b.toolbar.$el,".tb_module"),b.Mixins.Builder.initModuleDraggable(b.toolbar.$el,".tb_row_grid")));var c=this;setTimeout(function(){b.Utils.setCompactMode(c.el.getElementsByClassName("module_column"))},1E3);b.vent.trigger("dom:builder:change");setTimeout(c.insertLayoutButton.bind(c),200);b.init=!0},render:function(){for(var a=document.createDocumentFragment(),c=this.collection,d=!1,f=0,g=c.length;f<g;++f){var e=b.Views.init_row(c.models[f]);!1!==e&&(b.id&&(d=
e.model.get("row_order"),void 0===d&&(d=f)),b.id&&(b.VisualCache[e.model.cid]="themify_builder_"+b.id+"_row module_row_"+d),a.appendChild(e.view.render(d,f).el))}this.el.appendChild(a);b.Utils.columnDrag(!1,!1);return this},newRowAvailable:function(){var a=this.$el.children(".module_row:last");if(0===a.length||0<a.find(".active_module").length)a=b.Views.init_row({cols:[{grid_class:"col-full"}]}).view.render().$el,this.el.appendChild(a[0]),b.Mixins.Builder.updateModuleSort(a),"visual"===b.mode&&"desktop"!==
b.activeBreakPoint&&e("body",top_iframe).height(document.body.scrollHeight)},insertLayoutButton:function(){this.$el.find(".tb_import_layout_button").remove();2>this.$(".module_row").length&&this.el.insertAdjacentHTML("beforeend",'<a href="#" class="tb_import_layout_button'+(themifyBuilder.is_premium?"":" tb_lite")+'">'+themifyBuilder.i18n.text_import_layout_button+"</a>")},importLayoutButton:function(a){a.preventDefault();b.Views.Toolbar.prototype.loadLayout(a)}});b.Mixins.Common={styleData:{},doTheBinding:function(a,
...
d).on("themify_builder_change_mode",d).one("themify_builder_lightbox_before_close",function(){F=[];b.saving&&c(b.activeBreakPoint);Themify.body.off("themify_builder_change_mode",d)})},editComponentCallback:function(a,c,d,f){function g(a){b.hasChanged=!0;a=0;for(var c=v.length;a<c;++a)v[a].removeEventListener("change",g);v=null}function h(a){a=e(this).val();""!=a?ThemifyBuilderCommon.isImageUrl(a)?e(this).removeClass("tb_image_field_error"):(e(this).addClass("tb_image_field_error"),alert(themifyBuilder.i18n.incorrectImageURL)):
e(this).removeClass("tb_image_field_error")}var k="styling",l=b.Mixins.Common,m=c,n=[],p=[],r=[],z=[],x=[],t=[],q=[],u=!1,E="desktop"!==b.activeBreakPoint?Object.keys(themifyBuilder.breakpoints).reverse():!1;"module"===c&&(m=b.activeModel.get("mod_name"),k="mod_settings",u=void 0!==b.activeModel.get("is_new"));if(!1!==E){for(var A=E.indexOf(b.activeBreakPoint),w=0;w<=A;++w)E.shift();E.push("desktop")}var B=function(a,c,d,g){var h="";g?h=a.getAttribute("data-input-id"):(h=a.getAttribute("name"))||
(h=a.getAttribute("id"));var k=c&&void 0!==c[h]?c[h]:!1;if(f||"px"!==k&&"pixels"!==k&&"n"!==k&&"|"!==k&&"default"!==k&&"solid"!==k||a.classList.contains("themify-layout-icon")){var y=e(a),C=a.classList;if(!u&&!1!==E&&!g&&!k)if(C.contains("themify-checkbox"))void 0!==d[h]&&0===y.closest("#tb_options_styling").length&&(k=d[h]);else{g=0;for(var w=E.length;g<w;++g)if(void 0!==d["breakpoint_"+E[g]]&&void 0!==d["breakpoint_"+E[g]][h]){k=d["breakpoint_"+E[g]][h];break}else if("desktop"===E[g]&&void 0!==
d[h]){k=d[h];break}}if(C.contains("themify-gradient"))z.push({k:y,v:k}),k&&y.val(k);else if(C.contains("tb_range"))k&&y.val(k),x.push(y);else if(C.contains("tb_uploader_input"))k?(d=e("<img/>",{src:k,width:50,height:50}),y.val(k).parent().find(".img-placeholder").html(d)):f&&y.val("").parent().find(".img-placeholder").empty();else if(C.contains("themify-option-query-cat"))k&&(d=y.parent(),g=k.split("|")[0],d.find("#"+h+"_dropdown").children("option[value='"+g+"']").prop("selected",!0),d.find(".query_category_multiple").val(g));
else if(C.contains("tb_radio_input_container"))d=null,h=k?k:void 0!==y.data("default")?y.data("default"):!1,!1!==h&&""!==h?(d=y.find("input[value='"+h+"']"),d.is(":disabled")?d=null:d.prop("checked",!0)):f&&C.contains("tb_icon_radio")&&y.find("input").prop("checked",!1),null===d&&(d=y.find("input:checked")),0<d.length&&C.contains("tb_option_radio_enable")&&p.push(d);else if(C.contains("themify-checkbox")){d=y.find(".tb-checkbox");!k&&_.isEmpty(c)&&(k=d.map(function(){return e(this).is(":checked")?
e(this).val():null}).get().join("|"));if(k){var v=k.constructor===Array?k:k.split("|");d.each(function(){-1!==v.indexOf(e(this).val())&&e(this).prop("checked",!0)})}else if(!u||f)if(h=d.closest(".tb_input").find(".tb_seperate_items input"),h.length){var D=!1;h.each(function(){if(e(this).val().length)return D=!0,!1});d.prop("checked",!D)}else d.prop("checked",!1);C.contains("tb_option_checkbox_enable")&&r.push(d)}else if(C.contains("themify-layout-icon"))if(k){d=a.getElementsByClassName("tfl-icon");
h=0;for(g=d.length;h<g;++h)k===d[h].getAttribute("id")?d[h].classList.add("selected"):d[h].classList.remove("selected");d=null}else d=themifyBuilder.modules[m],void 0!==d&&void 0!==d.defaults&&d.defaults[h]?y.find("#"+d.defaults[h]).addClass("selected"):y.find("a").first().addClass("selected");else if("SELECT"===a.tagName){if(C.contains("unstick_el_row_select_input")||C.contains("unstick_el_module_select_input")){d=C.contains("unstick_el_module_select_input")?"module":"row";var A=[],F=b.activeModel.get("element_id");
d=b.Utils.getUIDList(d).filter(function(a){return a.element_id!==F});_.each(d,function(a){var b="row"===a.elType?"Row #"+a.element_id:a.mod_name+" #"+a.element_id;"row"===a.elType&&a.styling&&a.styling.custom_css_id&&(b="#"+a.styling.custom_css_id);"module"===a.elType&&a.mod_settings&&a.mod_settings.custom_css_id&&(b="#"+a.mod_settings.custom_css_id);A.push('<option value="'+a.element_id+'">'+b+"</option>")});y.html(A.join(""))}k?("maps-pro"!==m||"w_map_unit"!==h||k||(k=c.unit_w?c.unit_w:"px"),y.val(k),
C.contains("font-family-select")&&y.data("selected",k),C.contains("font-weight-select")&&y.attr("data_value",k)):f&&y.find("option").prop("selected",!1);f&&C.contains("font-family-select")&&(-1===y.prop("tabindex")?y.trigger("change.select"):k&&(d=y.find("optgroup"),void 0!==ThemifyBuilderCommon.safe_fonts[k]?d.first().html('<option selected="selected" data-type="webfont" value="'+k+'">'+ThemifyBuilderCommon.safe_fonts[k]+"</option>"):d.last().html('<option selected="selected" value="'+k+'">'+ThemifyBuilderCommon.google_fonts[k]+
"</option>")))}else if("TEXTAREA"===a.tagName||"INPUT"===a.tagName){d="TEXTAREA"===a.tagName;if(k||f)f&&!k&&(k=""),y.val(k),C.contains("minicolors-input")?(h=k,g="",-1!==k.indexOf("_")?(h=b.Utils.toRGBA(k),k=k.split("_"),(g=k[1])?0>=parseFloat(g)&&(g=0):g=1,y.val(k[0])):k&&(-1===k.indexOf("#")&&(h="#"+k),g=1),y.attr("data-opacity",g).next(".minicolors-swatch").find("span").css({background:h,opacity:g}).closest(".minicolors").next(".color_opacity").val(g)):d&&!u&&(C.contains("tb_shortcode_input")||
C.contains("tb_thumbs_preview"))&&l.getShortcodePreview(y,k);d&&C.contains("tb_lb_wp_editor")&&n.push(y)}else if(C.contains("tb_row_js_wrapper")){var w=k?k.length-1:0,G=e.Event("click",{isTrigger:!0,currentTarget:y.next(".add_new").find("a").first()});void 0===b.cache.repeaterElements[h]&&(c=a.getElementsByClassName("tb_repeatable_field"),b.cache.repeaterElements[h]=e(c[0]).clone());for(g=0;g<w;++g)b.Forms.moduleOptAddRow(G,null);c=a.getElementsByClassName("tb_repeatable_field");g=0;for(h=c.length;g<
h;++g){a=c[g].getElementsByClassName("tb_lb_option_child");for(var w=void 0!==k[g]?k[g]:!1,G=0,H=a.length;G<H;++G)B(a[G],w,d,!0)}t.push({el:y,binding_type:y.data("control-binding")})}y.data("binding")?q.push({el:y,v:k}):C.contains("themify-checkbox")&&y.find(".tb-checkbox").data("binding")&&q.push({el:y.find(".tb-checkbox"),v:k});f||!y.data("control-binding")||C.contains("tb_lb_wp_editor")||C.contains("minicolors-input")||C.contains("themify-gradient")||"repeater"===y.data("control-type")||b.Views.init_control(y.data("control-type"),
{el:y,binding_type:y.data("control-binding"),selector:y.data("live-selector")})}};d=f?d:b.activeModel.get(k);var D=e.extend(!0,{},d);if("desktop"!==b.activeBreakPoint||f)if(void 0!==D["breakpoint_"+b.activeBreakPoint])D=D["breakpoint_"+b.activeBreakPoint];else for(w=0,k=E.length;w<k;++w)if(void 0!==D["breakpoint_"+E[w]]){D=D["breakpoint_"+E[w]];break}e(a.querySelectorAll('.tb_uploader_input:not(#background_video):not([data-control-type="audio"])')).on("focus",function(a){if(void 0!==a.originalEvent)e(this).one("blur",
h)}).on("change paste keyup",function(){e(this).removeClass("tb_image_field_error")});for(var v=a.getElementsByClassName("tb_lb_option"),w=0,k=v.length;w<k;++w)B(v[w],D,d,!1),f||v[w].addEventListener("change",g,{once:!0});f&&(v=null);setTimeout(function(){for(var a=0,b=p.length;a<b;++a)ThemifyBuilderCommon.Lightbox.clickRadioOption(null,p[a]);p=null;a=0;for(b=r.length;a<b;++a)ThemifyBuilderCommon.Lightbox.clickCheckboxOption(null,r[a]);r=null},1);f||(0<t.length&&setTimeout(function(){for(var a=0,
c=t.length;a<c;++a)b.Views.init_control("repeater",t[a]);t=null},200),setTimeout(function(){q=q.reverse();for(var a=0,b=q.length;a<b;++a)l.doTheBinding(q[a].el,q[a].v);q=null},1),setTimeout(function(){for(var a=0,c=x.length;a<c;++a)b.Utils.createRange(x[a]);x=null},100));setTimeout(function(){l.applyAll_init(f);for(var b=a.getElementsByClassName("border_style"),c=0,d=b.length;c<d;++c)ThemifyBuilderCommon.Lightbox.hideShowBorder(null,e(b[c]))},10);void 0!==e.fn.ThemifyGradient&&setTimeout(function(){for(var a=
0,c=z.length;a<c;++a)b.Utils.createGradientPicker(z[a].k,z[a].v,f);z=null},400);f||(setTimeout(function(){ThemifyBuilderCommon.fontPreview(ThemifyBuilderCommon.Lightbox.$lightbox.find("#tb_lightbox_container"))},300),u&&"gallery"===m&&setTimeout(function(){e(".tb_gallery_btn",a).trigger("click")},1),setTimeout(function(){b.Utils.builderPlupload("normal")},120),setTimeout(function(){b.Utils.setColorPicker(a)},1),"module"!==c?setTimeout(function(){b.Utils.setImageSelect(a)},800):setTimeout(function(){b.Utils.datePicker(a)},
100),"visual"===b.mode&&(setTimeout(function(){F="module"===c?b.Forms.serialize("tb_options_setting"):D;b.liveStylingInstance.init(F)},1),u||ThemifyBuilderCommon.Lightbox.rememberRow()),setTimeout(function(){if(0<n.length){var a=function(){for(var a=0,c=n.length;a<c;++a)b.Views.init_control("wp_editor",{el:n[a],binding_type:n[a].data("control-binding"),selector:n[a].data("live-selector")});n=null};if(b.activeModel.get("styleClicked")||b.activeModel.get("visibileClicked"))Themify.body.on("themify_builder_tabsactive",
function H(b,c,d){"#tb_options_setting"===c&&(a(),Themify.body.off("themify_builder_tabsactive",H))});else a()}l.mode_change(c)},1),Themify.body.trigger("editing_"+c+"_option",[m,D,a]),"visual"===b.mode&&window.top.jQuery("body").trigger("editing_"+c+"_option",[m,D,a]))},applyAll_init:function(a){var b=e(".style_apply_all",top_iframe);b.off("change.tb_apply_all").on("change.tb_apply_all",function(a){var b;e(this).parent().css("display","inline-block");var c=e(this).closest(".tb_input").find(".tb_seperate_items"),
d=c.find("li");a=!a.isTrigger;var k=e(this).hasClass("tb_has_radio_options")?!0:!1;k&&(b=e(this).siblings("input:radio"));e(this).is(":checked")?(k&&b.addClass("_tb_disable"),d.not(":first-child").hide(),d.first().find("span.tb_tooltip_up").hide(),d.first().find("span.tb_range_after").hide(),c.attr("data-checked",1)):(k&&b.removeClass("_tb_disable"),d.show(),d.first().find("span.tb_range_after").show(),d.first().find("span.tb_tooltip_up").show(),c.removeAttr("data-checked"),k&&d.first().find("select").trigger("change"));
a&&d.first().find("select").trigger("change")});b.each(function(){e(this).parent().css("display","inline-block");if(e(this).hasClass("tb_has_radio_options")){var a=this;e(this).siblings("input:radio").on("click",function(b){e(a).trigger("change.tb_apply_all")})}});a||(b=b.filter(":checked"));b.trigger("change.tb_apply_all")},getShortcodePreview:function(a,b){function c(b){a.next(".tb_shortcode_preview").remove();b&&a.after(b)}var f=this;void 0===f.galerry_cache&&(f.galerry_cache={});void 0!==f.galerry_cache[b]?
c(f.galerry_cache[b]):e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_load_shortcode_preview",tb_load_nonce:themifyBuilder.tb_load_nonce,shortcode:b},success:function(a){c(a);f.galerry_cache[b]=a}})}};b.Mixins.Builder={before:null,zindex:null,r:null,w:null,h:null,type:null,moduleHolderArgs:null,subrows:null,update:function(a){var c=null!==b.activeModel?b.activeModel.get("elType"):b.Models.Registry.lookup(a.data("cid")).get("elType");"visual"===b.mode&&b.Utils.loadContentJs(a,c);a=
a.closest(".module_row");b.Utils.columnDrag(a.find(".row_inner"),!1);b.Utils.columnDrag(a.find(".subrow_inner"),!1);b.Mixins.Builder.updateModuleSort(a)},dragScroll:function(a,c){function d(a){a=e(this).prop("id");a=("tb_toolbar"===a||"wpadminbar"===a?"-":"+")+("="+m+"px");g.stop().animate({scrollTop:a},800)}var f=e("body",top_iframe);"visual"===b.mode&&(f=f.add(Themify.body));void 0===this.top&&(this.top=b.toolbar.$el,this.top=this.top.add(e("#tb_fixed_bottom_scroll",top_iframe)),"visual"!==b.mode&&
(this.top=this.top.add("#wpadminbar")));if(!0===c)this.top.off("mouseenter"),"row"===a&&"visual"===b.mode&&b.toolbar.$el.find('.tb_zoom[data-zoom="100"]').trigger("click"),f.removeClass("tb_drag_start tb_drag_"+a);else{var g="desktop"===b.activeBreakPoint?e("body,html"):e("body,html",top_iframe),h=0;if("visual"===b.mode){var k=g.height();h=e(window.top).height()}else k=e("#page-builder").height();var l=k-h,m=(k-h)*(1E4<l?2:5E3<l?5:10)/100;f.addClass("tb_drag_start tb_drag_"+a);"row"===a&&"visual"===
b.mode&&b.toolbar.$el.find('.tb_zoom[data-zoom="50"]').trigger("click");if(0<m)this.top.off("mouseenter").on("mouseenter",d)}},rowSort:function(){var a=this,c,d={items:">.module_row",handle:".tb_row_actions>.tb_grid_icon",axis:"y",placeholder:"tb_state_highlight",containment:"parent",tolerance:"pointer",forceHelperSize:!0,forcePlaceholderSize:!0,scroll:!1,beforeStart:function(b,d,e){a.before||(c=!0,a.before=e.item.next(".module_row"),0===a.before.length&&(a.before=e.item.prev(".module_row"),c=!1),
a.before=a.before.data("cid"),a.dragScroll("row"))},stop:function(b,d){a.before=c=null;a.dragScroll("row",!0)},update:function(d,g){if("visual"===b.mode&&!g.item.hasClass("tb_row_grid")){var f="desktop"===b.activeBreakPoint?e("html,body"):e("body",top_iframe);f.scrollTop(g.item.offset().top);f=null}if("sortupdate"===d.type&&a.before){b.hasChanged=!0;var f=g.item.next(".module_row"),k=!0;0===f.length&&(f=g.item.prev(".module_row"),c=k=!1);f=f.data("cid");b.undoManager.push(g.item.data("cid"),null,
null,"row_sort",{bnext:c,before:a.before,anext:k,after:f})}else g.item.hasClass("predesigned_row")||g.item.hasClass("tb_page_break_module")||"row"===g.item.data("type")?"row"===g.item.data("type")?b.toolbar.libraryItems.get(g.item.data("id"),"row",function(b){Array.isArray(b)||(b=Array(b));a.rowDrop(b,g.item)}):g.item.hasClass("tb_page_break_module")?b.toolbar.pageBreakModule.get(function(b){a.rowDrop(b,g.item)}):b.toolbar.preDesignedRows.get(g.item.data("slug"),function(b){a.rowDrop(b,g.item)}):
g.item.hasClass("tb_row_grid")&&a.subRowDrop(g.item.data("slug"),g.item);b.toolbar.pageBreakModule.countModules()}};"visual"===b.mode&&(d.helper=function(){return e('<div class="tb_sortable_helper"/>')});this.$el.sortable(d)},columnSort:function(a){var c,d;a.find(".row_inner, .subrow_inner").sortable({items:"> .module_column",handle:"> .tb_column_action .tb_column_dragger",axis:"x",placeholder:"tb_state_highlight",tolerance:"pointer",cursorAt:{top:20,left:20},beforeStart:function(a,b,e){Themify.body.addClass("tb_drag_start");
c=ThemifyBuilderCommon.clone(e.item.closest(".module_row"));d=e.item.siblings();d.css("marginLeft",0)},start:function(a,b){e(".tb_state_highlight").width(b.item.width())},stop:function(a,b){Themify.body.removeClass("tb_drag_start");d.css("marginLeft","")},update:function(a,d){var f=d.item.closest(".ui-sortable"),g=f.children(".module_column");g.removeClass("first last");f.hasClass("direction-rtl")?(g.last().addClass("first"),g.first().addClass("last")):(g.first().addClass("first"),g.last().addClass("last"));
b.Utils.columnDrag(f,!1);b.Utils.setCompactMode(g);f=f.closest(".module_row");b.undoManager.push(f.data("cid"),c,f,"row")}})},updateModuleSort:function(a,c){var d=e(".tb_holder",a);if(c)return d.sortable(c),!1;d.each(function(){e(this).data({uiSortable:null,sortable:null})});var f=this,g=null,h,k;this.moduleHolderArgs={placeholder:"tb_state_highlight",items:".active_module,>div>.active_module",connectWith:".module_row:not(.tb-page-break) .tb_holder",revert:100,scroll:!1,cancel:".tb_disable_sorting",
cursorAt:{top:10,left:90},sort:function(a,b){null===g&&(g=this.classList.contains("active_module")?this.children:e(this).find(e(this).sortable("option").items).get(),k=e(this).children(".tb_state_highlight:first"),h=b.helper.outerHeight());for(var c=b.position.top,d=c+h,m=0,l=g.length;m<l;++m)if(!g[m].classList.contains("tb_sortable_helper")&&!g[m].classList.contains("tb_state_highlight")){var x=e(g[m]);var t=x.outerHeight();var q=x.position().top;var u=q+t;if(c>q&&c<u){if(t=Math.min(f.helpHeight,
t)/2,u=c-q,u<t){k.insertBefore(x);e(this).sortable("refreshPositions");break}}else if(d<u&&d>q&&(t=Math.min(f.helpHeight,t)/2,u-=d,u<t)){k.insertAfter(x);e(this).sortable("refreshPositions");break}}},beforeStart:function(a,b,c){if(!f.before&&(f.r=c.item.closest(".module_row"),0<f.r.length?(f.before=ThemifyBuilderCommon.clone(f.r),f.zindex=f.r.css("zIndex"),"auto"===f.zindex&&(f.zindex=""),f.r.css("zIndex",2)):f.r=null,f.w=c.item[0].style.width,f.h=c.item[0].style.height,c.item.css({width:180,height:30}),
f.type="module",f.subrows=null,c.item[0].classList.contains("module_subrow")?(f.type+=" tb_drag_subrow",f.subrows=!0):c.item[0].classList.contains("tb_row_grid")&&(f.type="column",f.subrows=!0),f.dragScroll(f.type),!0===f.subrows)){f.subrows=[];a=[];c=0;for(var d=b.items.length;c<d;++c)b.items[c].instance.element[0].classList.contains("tb_subrow_holder")?(f.subrows.push(b.items[c].instance.element),b.items[c].instance.destroy()):a.push(b.items[c]);b.items=a;a=[];c=0;for(d=b.containers.length;c<d;++c)b.containers[c].element[0].classList.contains("tb_subrow_holder")?
(f.subrows.push(b.containers[c].element),b.containers[c].destroy()):a.push(b.containers[c]);b.containers=a}},stop:function(a,c){"visual"===b.mode&&c.helper&&e(c.helper).remove();c.item.css({width:f.w,height:f.h});f.dragScroll(f.type,!0);f.r&&f.r.css("zIndex",f.zindex);f.before=f.w=f.h=g=k=f.r=f.zindex=h=f.type=null;if(f.subrows)for(var d=0,m=f.subrows.length;d<m;++d)f.subrows[d][0].classList.contains("ui-sortable")||f.subrows[d].sortable(f.moduleHolderArgs);f.subrows=null},update:function(a,c){c.item.css({width:f.w,
height:f.h});if(c.item.hasClass("tb_module_dragging_helper")){F=[];var g=e(c.item.clone(!1));if(c.item.data("id")){var h=c.item.closest(".module_row");0<h.length&&(f.before=ThemifyBuilderCommon.clone(h),f.before.find(".tb_module_dragging_helper").remove())}c.item.after(g);f.moduleDrop(g,null,f.before)}else{if(c.sender&&(g=c.sender.closest(".module_row"),c.sender.closest(".module_row").toggleClass("tb_row_empty",0===g.find(".active_module").length),g=c.sender.closest(".module_subrow"),0<g.length&&
g.toggleClass("tb_row_empty",0===g.find(".active_module").length),c.item.hasClass("module_subrow")&&0<c.item.parent().closest(".module_subrow").length)){d.sortable("cancel");return}f.before&&(b.hasChanged=!0,c.item.hasClass("module_subrow")||c.item.closest(".module_subrow").removeClass("tb_row_empty"),g=c.item.closest(".module_row"),g.removeClass("tb_row_empty"),b.undoManager.push(c.item.data("cid"),f.before,g,"sort",{before:f.before.data("cid"),after:g.data("cid")}),f.before=null,b.vent.trigger("dom:builder:change"),
Themify.body.trigger("tb_"+f.type+"_sort",[c.item]))}}};"visual"===b.mode&&(this.moduleHolderArgs.helper=function(){return e('<div class="tb_sortable_helper"/>')});d.sortable(this.moduleHolderArgs)},initModuleDraggable:function(a,c){var d=this,f=e.extend(!0,{},this.moduleHolderArgs);f.update=!1;f.appendTo=document.body;f.items=c;".tb_row_grid"===c&&(f.connectWith=[f.connectWith,"visual"===b.mode?"#themify_builder_content-"+themifyBuilder.post_ID:"#tb_row_wrapper"]);f.stop=function(a,b){e(this).sortable("cancel");
b.item.removeClass("tb_sortable_helper tb_module_dragging_helper");d.moduleHolderArgs.stop(a,b)};f.start=function(a,b){b.item.addClass("tb_sortable_helper tb_module_dragging_helper")};f.helper=function(a,b){return e('<div class="tb_sortable_helper tb_module_dragging_helper">'+b.text()+"</div>")};a.sortable(f)},initRowDraggable:function(a,c){var d=this;a.find(c).draggable({appendTo:Themify.body,helper:"clone",revert:"invalid",connectToSortable:"visual"===b.mode?"#themify_builder_content-"+themifyBuilder.post_ID:
"#tb_row_wrapper",cursorAt:{top:10,left:40},start:function(a,b){d.dragScroll("row");b.helper.addClass("tb_module_dragging_helper tb_sortable_helper").find(".tb_predesigned_rows_list_image").remove()},stop:function(a,b){d.dragScroll("row",!0)}})},initModuleVisualDrag:function(a){var c=this;b.toolbar.$el.find(a).ThemifyDraggable({iframe:"#tb_iframe",dropitems:".tb_holder",elements:".active_module",type:"module",onDrop:function(a,b,g){c.moduleDrop(b,!1,ThemifyBuilderCommon.clone(g.closest(".module_row")))}})},
initRowGridVisualDrag:function(){var a=this;b.toolbar.$el.find(".tb_row_grid").ThemifyDraggable({iframe:"#tb_iframe",dropitems:".tb_holder:not('.tb_subrow_holder'),.themify_builder_content:not('.not_editable_builder')>.module_row",elements:".active_module",cancel:".tb_subrow_holder",append:!1,type:"column",onDrop:function(b,d,f){a.subRowDrop(d.data("slug"),d)}})},initRowVisualDrag:function(a){var c=this;b.toolbar.$el.find(a).ThemifyDraggable({iframe:"#tb_iframe",dropitems:".themify_builder_content:not('.not_editable_builder')>.module_row",
append:!1,type:"row",onDrop:function(a,f,g){f.addClass("tb_state_highlight").find(".tb_predesigned_rows_list_image").remove();f.show();a="desktop"===b.activeBreakPoint?e("html,body"):e("body",top_iframe);a.scrollTop(f.offset().top-e("#headerwrap.fixed-header").outerHeight());a=null;"row"===f.data("type")?b.toolbar.libraryItems.get(f.data("id"),"row",function(a){Array.isArray(a)||(a=Array(a));c.rowDrop(a,f)}):f.hasClass("tb_page_break_module")?b.toolbar.pageBreakModule.get(function(a){c.rowDrop(a,
f)}):b.toolbar.preDesignedRows.get(f.data("slug"),function(a){c.rowDrop(a,f)})}})},subRowDrop:function(a,c){var d=0<c.parent(".themify_builder_content,#tb_row_wrapper").length;if(d||0===c.closest(".sub_column").length){a=b.Utils.grid(a);if(!d){var f=ThemifyBuilderCommon.clone(c.closest(".module_row"));f.find(".tb_row_grid").remove();var g="row"}var e=(d?b.Views.init_row({cols:a[0].cols}):b.Views.init_subrow({cols:a[0].cols})).view.render().$el;if(d||0<c.parent(".tb_holder").length)c[0].parentNode.replaceChild(e[0],
c[0]);else{var k=c.next(".tb_holder");0<k.length?k.prepend(e):(k=c.prev(".tb_holder"),k.append(e))}if(d){f=e.next(".module_row");var l=!0;0===f.length&&(l=!1,f=e.prev(".module_row"));f=f.data("cid");g="grid_sort"}e.find(".tb_grid_"+b.activeBreakPoint+' .tb_grid_list [data-col="'+a[0].cols.length+'"]').first().parent().addClass("selected");b.Utils.setCompactMode(e[0].getElementsByClassName("module_column"));b.Mixins.Builder.update(e);c.remove();b.hasChanged=!0;e=e.closest(".module_row");d||e.removeClass("tb_row_empty");
e.find(".tb_row_grid").remove();b.undoManager.push(e.data("cid"),f,e,g,{next:l})}else c.remove()},rowDrop:function(a,c){function d(){var a=c.prev(".module_row");if(0===a.length){var d="visual"===b.mode?c.closest(".themify_builder_content").data("postid"):null;a=!1}else a=a.data("cid");c[0].innerHTML="";c[0].parentNode.replaceChild(g,c[0]);b.hasChanged=!0;b.undoManager.push("","","","predesign",{prev:a,rows:e,bid:d});a=0;for(d=e.length;a<d;++a){var f=e[a].find(".module_column");e[a].find('ul.tb_grid_list li a[data-col="'+
f.length+'"]').first().parent().addClass("selected");b.Utils.setCompactMode(f);b.Mixins.Builder.update(e[a])}ThemifyBuilderCommon.showLoader("hide")}for(var f=function(a){for(var b in a)if(a[b].styling&&0<Object.keys(a[b].styling).length||a[b].modules&&0<Object.keys(a[b].modules).length)return!0;return!1},g=document.createDocumentFragment(),e=[],k=[],l=0,m=a.length;l<m;++l)if(a[l].styling&&0<Object.keys(a[l].styling).length||a[l].cols&&f(a[l].cols)){var n=b.Views.init_row(a[l]);if(!1!==n){n=n.view.render();
g.appendChild(n.el);if("visual"===b.mode){var p=n.el.querySelectorAll("[data-cid]");k[n.el.dataset.cid]=1;l=0;for(m=p.length;l<m;++l)k[p[l].dataset.cid]=1}e.push(n.$el)}}"visual"===b.mode?(b.bootstrap(k,d),k=null):d()},moduleDrop:function(a,c,d){function f(f){function g(f){k||l.model.set({is_new:1},{silent:!0});f=!0===f?l.model.getPreviewSettings():l.model.get("mod_settings");c?c.append(p.el):a.replaceWith(p.el);k?b.activeModel=l.model:l.view.trigger("edit",null);b.hasChanged=!0;if("visual"===b.mode&&
1<Object.keys(f).length)if("part"===h||"ajax"===a.data("type")){var g=!0;l.model.trigger("custom:preview:refresh",f)}else"module"!==h&&l.model.trigger("custom:preview:live",f);if(k){if(g){var m=l.view.$el.find(".tb_preview_component").detach();setTimeout(function(){l.view.$el.prepend(m)},50)}d&&(g=p.$el.closest(".module_row"),g.removeClass("tb_row_empty").find(".tb_module_dragging_helper").remove(),p.$el.closest(".module_subrow").removeClass("tb_row_empty"),b.undoManager.push(g.data("cid"),d,g,"row"),
b.vent.trigger("dom:builder:change"),e(".tb_import_layout_button").remove())}}var l=b.Views.init_module(f),p=l.view.render();"visual"===b.mode&&k?(f=[],f[l.model.cid]=1,b.bootstrap(f,g)):g(!0)}if(a[0].classList.contains("tb_row_grid"))this.subRowDrop(a.data("slug"),a);else{var g={mod_name:a.data("module-slug")},h=a.data("type"),k="part"===h||"module"===h;k?b.toolbar.libraryItems.get(a.data("id"),h,f):f(g);"visual"!==b.mode&&e(".themify-wp-editor-holder:not(.themify-active-holder)").length&&e(".themify-wp-editor-holder").addClass("themify-active-holder")}},
toJSON:function(){for(var a={},c=this.el.getElementsByClassName("module_row"),d=0,f=0,g=c.length;f<g;++f){var e=b.Utils._getRowSettings(c[f],f);0<Object.keys(e).length&&(a[d]=e,++d)}return a}};b.Forms={Data:{},Validators:{},bindEvents:function(){var a="true"===themifyBuilder.isTouch?"touchend":"click";e("body",top_iframe).on(a,".builder_save_button",this.saveComponent).on(a,"#tb_lightbox_parent .add_new a",this.moduleOptAddRow).on(a,"#tb_submit_import_form",this.builderImportSubmit).on(a,".tb_lightbox_switcher a",
this.lightbox_switcher).on(a,".layout_preview img",this.templateSelected).on(a,"#builder_submit_layout_form",this.saveAsLayout).on(a,"#builder_submit_library_item_form",this.saveAsLibraryItem).on("keypress","#tb_library_item_form input",this.saveAsLibraryItem).on("keyup","#row_anchor",this.rowAnchor);Themify.body.on("themify_builder_lightbox_close",this.clear).on(a,".tb_module_front a",this.disable_links);b.Mixins.Common.moduleOptionsBinding()},parseSettings:function(a,b,d,f){var c=!1,h=e(a),k=a.classList,
l="",m=!0;f?l=h.data("input-id"):(l=a.getAttribute("name"))||(l=a.getAttribute("id"));if(k.contains("tb_lb_wp_editor"))void 0!==tinyMCE?(c=a.getAttribute("id"),k=tinyMCE.get(c),c=null!==k?!1===k.hidden?k.getContent():switchEditors.wpautop(tinymce.DOM.get(c).value):h.val()):c=h.val();else if(k.contains("themify-checkbox")){var n=[];h.find(".tb-checkbox:checked").each(function(a){n.push(e(this).val())});c=0<n.length?n.join("|"):!1;n=null;m=!1}else if(k.contains("themify-layout-icon"))c=h.find(".selected").prop("id"),
m=!k.contains("tb_frame");else if(k.contains("themify-option-query-cat"))k=h.parent(),c=k.find(".query_category_single"),k=k.find(".query_category_multiple"),c=k.val()?k.val()+"|multiple":c.val()+"|single";else if(k.contains("tb_row_js_wrapper"))for(c=[],k=a.getElementsByClassName("tb_repeatable_field_content"),a=0,f=k.length;a<f;++a){var p=k[a].getElementsByClassName("tb_lb_option_child");c[a]={};for(var r=0,z=p.length;r<z;++r){var x=this.parseSettings(p[r],b,d,!0);x&&"px"!==x.v&&"n"!==x.v&&"pixels"!==
x.v&&"solid"!==x.v&&"default"!==x.v&&"|"!==x.v&&(c[a][x.id]=x.v)}}else k.contains("tb_radio_input_container")?(m=h.find("input:checked"),"desktop"!==d&&m.hasClass("reponive_disable")||(c=m.val()),m=!1):k.contains("module-widget-form-container")?c=h.find(":input").themifySerializeObject():k.contains("tb_widget_select")?c=h.find(".selected").data("value"):(c=h.val(),""!==c?(m=h.attr("data-opacity"),void 0!==m&&""!==m&&1!=m&&"0.99"!=m&&(c+="_"+m),m=!k.contains("tb_frame")&&!k.contains("border_color")&&
!k.contains("border_width")):c=!1);if(c||!b)if(!b||b&&"px"!==c&&"pixels"!==c&&"n"!==c&&"solid"!==c&&"linear"!==c&&"default"!==c&&"|"!==c&&("desktop"===d||0===h.closest(".reponive_disable").length))return b||!1!==c||(c=""),{id:l,v:c,checked:m};return!1},serialize:function(a,c,d){d=d||b.activeBreakPoint;var f=void 0!==c;void 0===this.breakpoints&&"desktop"!==d&&f&&(this.breakpoints=Object.keys(themifyBuilder.breakpoints).reverse());var e={};a=top_iframe.getElementById(a).getElementsByClassName("tb_lb_option");
var h="desktop"!==d&&f&&void 0!==this.breakpoints?this.breakpoints:!1;if(!1!==h){for(var k=h.indexOf(d),l=0;l<=k;++l)h.shift();h.push("desktop")}l=0;for(k=a.length;l<k;++l){var m=this.parseSettings(a[l],f,d,!1);if(!1!==m){if(!1!==h&&!0===m.checked&&"SELECT"!==a[l].tagName){for(var n=!1,p=0,r=h.length;p<r;++p)if(void 0!==c["breakpoint_"+h[p]]&&void 0!==c["breakpoint_"+h[p]][m.id]&&c["breakpoint_"+h[p]][m.id]===m.v){n=!0;break}else if("desktop"===h[p]&&void 0!==c[m.id]&&c[m.id]===m.v){n=!0;break}if(n)continue}e[m.id]=
m.v}}return e},saveComponent:function(a){var c=null===a;c||a.preventDefault();if(b.hasChanged){var d=b.Forms,f=b.activeModel.get("elType");a="module"===f;if(!a||d.isValidate(e("#tb_module_settings",top_iframe))){Themify.body.trigger("themify_builder_save_component");"visual"===b.mode&&window.top.jQuery("body").trigger("themify_builder_save_component");b.saving=!0;var g={},h=null,k=!1,l=!1,m=null,n=null,p="styling",r=e(".tb_element_cid_"+b.activeModel.cid);if(a||"row"===f||"subrow"===f)a&&(p="mod_settings",
k=b.activeModel.get("is_new"),b.activeModel.unset("is_new",{silent:!0})),"subrow"!==f&&(n=d.serialize("tb_options_setting")),h=d.serialize("tb_options_animation");if(a||"row"===f||"subrow"===f)m=d.serialize("tb_options_visibility"),"visual"===b.mode&&("hide_all"===m.visibility_all||"hide"===m.visibility_desktop||"hide"===m.visibility_tablet||"hide"===m.visibility_mobile?r.addClass("tb_visibility_hidden"):r.removeClass("tb_visibility_hidden"));"visual"===b.mode&&b.liveStylingInstance.remember(b.activeModel.cid);
c?Themify.body.trigger("themify_builder_lightbox_before_close"):ThemifyBuilderCommon.Lightbox.close(c);d=e.extend(!0,{},b.Mixins.Common.styleData);f=d.breakpoint_desktop;d.breakpoint_desktop=null;for(var z in d)f[z]=d[z];g[p]=e.extend(!0,f,n,h,m);g[p]=b.Utils.clear(g[p]);z=b.activeModel.get(p);b.activeModel.set(g,{silent:!0});a&&(k&&(l=r.closest(".module_column"),l.closest(".module_row").removeClass("tb_row_empty"),l.closest(".module_subrow").removeClass("tb_row_empty"),l=ThemifyBuilderCommon.clone(l)),
b.vent.trigger("dom:builder:change"),e(".tb_import_layout_button").remove());if("visual"===b.mode){var x=b.liveStylingInstance.undoData;var t=e.extend(!0,{},b.liveStylingInstance.getRememberedStyles())}b.undoManager.push(b.activeModel.cid,b.beforeEvent,r,"save",{bsettings:z,asettings:g[p],bstyles:x,astyles:t,column:l});b.beforeEvent=!1;b.saving=!1;c&&ThemifyBuilderCommon.Lightbox.close(c)}}else ThemifyBuilderCommon.Lightbox.close(c)},moduleOptAddRow:function(a,c){function d(a){a=e(this).val();""!=
a?ThemifyBuilderCommon.isImageUrl(a)?e(this).removeClass("tb_image_field_error"):(e(this).addClass("tb_image_field_error"),alert(themifyBuilder.i18n.incorrectImageURL)):e(this).removeClass("tb_image_field_error")}a.preventDefault();var f=e(a.currentTarget).parent().prev(),g=b.cache.repeaterElements[f.prop("id")].clone(),h=Math.random().toString(36).substr(2,7),k=[],l=!1,m=!1,n=[],p=!a.isTrigger||c;g.removeClass("collapsed").find(".row_inner").show();var r=g[0].getElementsByClassName("tb_lb_option_child");
c=c?e(c):!1;for(var z=0,x=r.length;z<x;++z){var t=e(r[z]);var q=c?c.find('[data-input-id="'+t.data("input-id")+'"]'):!1;var u=r[z].classList;if(u.contains("tb_lb_wp_editor")){var E=t.data("input-id");var v=t.data("control-repeater");var w=t.closest(".wp-editor-wrap");t=E+"_"+z+"_"+Math.random().toString(36).substr(2,7);!1===l&&(l=w[0].innerHTML);w[0].innerHTML=l.replace(new RegExp(E,"g"),t);t=w.find(".tb_lb_wp_editor");t.attr({name:E,"data-input-id":E,"data-control-repeater":v}).data({"input-id":E,
"control-repeater":v});q?(q=q.prop("id"),q=(w=tinyMCE.get(q))&&!1===w.hidden?w.getContent():switchEditors.wpautop(tinymce.DOM.get(q).value),t.val(q)):t.val("");k.push(t)}else if(u.contains("themify-layout-icon"))w=t.find("a"),w.removeClass("selected"),q?w.filter("#"+q.find(".selected").prop("id")).addClass("selected"):(q=themifyBuilder.modules[b.activeModel.get("mod_name")],void 0!==q&&void 0!==q.defaults&&q.defaults[E]?w.filter("#"+q.defaults[E]).addClass("selected"):w.first().addClass("selected"));
else if(u.contains("tb_uploader_input"))p&&(m=!0,q=!1!==q?q.val():"",w=t.val(q).parent(),v=w.find(".thumb_preview").find(".img-placeholder"),w.find(".tb_upload_btn").prop("id","pluploader_"+h+"_"+z+"tb_plupload_upload_ui").addClass("plupload-clone").find(".builder_button").prop("id","pluploader_"+h+"_"+z+"tb_plupload_browse_button"),""!==q&&(q=e("<img/>",{src:q,width:50,height:50}),v.html(q)));else if(u.contains("tb_radio_input_container")){w=r[z].getElementsByClassName("tb_radio_dnd");v=t.data("input-id");
var A=q?q.find(":checked").val():!1;q=0;for(var D=w.length;q<D;++q){var B=e(w[q]);B.prop({name:v+"_"+h,id:v+"_"+h+"_"+q,checked:!1}).next("label").prop("for",v+"_"+h+"_"+q);(A===B.val()||!A&&B.data("checked"))&&B.prop("checked",!0)}u.contains("tb_option_radio_enable")&&ThemifyBuilderCommon.Lightbox.clickRadioOption(null,t.find(":checked"))}else A=q?q.val():"",void 0===A&&(A=""),t.val(A),p&&(u.contains("tb_range")?n.push(t):q&&u.contains("minicolors-input")&&(w=q.closest(".minicolors_wrapper"),v=w.find(".minicolors-swatch-color"),
D=t.closest(".minicolors_wrapper"),q=q.data("opacity"),D.find(".minicolors-swatch-color").css({"background-color":v.css("background-color"),opacity:q}),D.find(".color_opacity").val(w.find(".color_opacity").val()),t.data("opacity",q).attr("data-opacity",q),v=D=q=w=null));p&&(t.data("binding")&&b.Mixins.Common.doTheBinding(t,A,g),!t.data("control-binding")||u.contains("tb_lb_wp_editor")||u.contains("minicolors-input")||u.contains("themify-gradient")||b.Views.init_control(t.data("control-type"),{el:t,
binding_type:t.data("control-binding"),selector:t.data("live-selector")}))}e(g[0].querySelectorAll('.tb_uploader_input:not([data-control-type="audio"])')).on("focus",function(a){e(this).removeClass("tb_image_field_error");if(void 0!==a.originalEvent)e(this).one("blur",d)});p&&setTimeout(function(){b.Utils.setColorPicker(g)},1);f[0].appendChild(g[0]);p&&(0<k.length&&setTimeout(function(){for(var a=0,c=k.length;a<c;++a)b.Views.init_control("wp_editor",{el:k[a],binding_type:k[a].data("control-binding"),
...
h=b.Models.Registry.lookup(n.$el.find(".active_module").data("cid"))}else h=b.Views.init_module(a.replWith),n=h.view.render(),h=h.model;d.replaceWith(n.el);if("visual"===b.mode)e(document).ajaxComplete(function t(a,c,d){-1!==d.data.indexOf("tb_load_module_partial",3)&&(e(this).off("ajaxComplete",t),p="row"===f?b.liveStylingInstance.$liveStyledElmt.closest(".module_row"):b.liveStylingInstance.$liveStyledElmt,b.undoManager.push(n.$el.data("cid"),g,p,"row"))}),h.trigger("custom:preview:refresh",h.get("mod_settings"));
else{var p=n.el;b.Mixins.Builder.updateModuleSort(n.$el);b.undoManager.push(n.$el.data("cid"),g,p,"row")}}d=e(".tb_library_item_list");a=b.toolbar.libraryItems.template([a]);"visual"===b.mode&&(d=d.add(b.toolbar.$el.find(".tb_library_item_list")));d=d.get();h=0;for(var r=d.length;h<r;++h){var z=d[h].getElementsByClassName("simplebar-content");0<z.length&&(z[0].insertAdjacentHTML("afterbegin",a),e(d[h]).closest(".tb_module_panel_tab").find(".tb_module_types .active a").trigger("click"))}b.toolbar.libraryItems.bindEvents(!0);
...
"click .tb_toolbar_save":"save","click .tb_toolbar_backend_edit a":"save","click .tb_toolbar_close_btn":"panelClose","click .tb_breakpoint_switcher":"breakpointSwitcher","click .tb_zoom":"zoom","click .tb_toolbar_zoom_menu_toggle":"zoom","click .tb_toolbar_builder_preview":"previewBuilder"},render:function(){setTimeout(v,1);var a=[],c=this,d=this.$el.find(".tb_module_panel_modules_wrap"),f=wp.template("builder_module_item_draggable"),g;for(g in themifyBuilder.modules)a.push(f({slug:g,name:themifyBuilder.modules[g].name,
...
f="desktop"===a,g=f||"desktop"===b,h=0,k=c.length;h<k;++h){var l=c[h].getAttribute("data-basecol");if(l){var m=c[h].children,n=c[h].dataset["col_"+a],p=m[0],r=m[m.length-1];if(!f){if("desktop"!==b){c[h].classList.remove("tb_3col");var z=c[h].getAttribute("data-col_"+b);z&&c[h].classList.remove(e.trim(z.replace("tb_3col","").replace("mobile","column").replace("tablet","column")))}if(n&&"-auto"!==n){if(n=c[h].getAttribute("data-col_"+a))c[h].classList.add("tb_grid_classes"),c[h].classList.add("col-count-"+
l),n=n.split(" "),n.map(function(a){c[h].classList.add(e.trim(a.replace("mobile","column").replace("tablet","column")))})}else c[h].classList.remove("tb_grid_classes"),c[h].classList.remove("col-count-"+l)}if(g)for(l=0,n=m.length;l<n;++l)z=e(m[l]).data("w"),void 0!==z&&(m[l].style.width=f?z+"%":"");"rtl"===c[h].getAttribute("data-"+a+"_dir")?(p.classList.remove("first"),p.classList.add("last"),r.classList.remove("last"),r.classList.add("first"),c[h].classList.add("direction-rtl")):(p.classList.remove("last"),
p.classList.add("first"),r.classList.remove("first"),r.classList.add("last"),c[h].classList.remove("direction-rtl"))}}},Panel:{el:null,is_locked:!1,key:"tb_module_panel_locked",init:function(){this.el=b.toolbar.$el.find(".tb_toolbar_add_modules_wrap");this.el.find(".tb_module_panel_lock").on("click",this.lock.bind(this));this._setupModulePanelState();this.el.find(".add_module_btn").on("click",this.add_module);this.compactToolbar()},add_module:function(a,c){a.preventDefault();a.stopPropagation();c=
...
c,d){var f={};d=d||"row";var g={};var h=b.Models.Registry.lookup(a.dataset.cid);if(h){a=a.getElementsByClassName(d+"_inner")[0];g=a.children;d=0;for(var k=g.length;d<k;++d){var l=b.Models.Registry.lookup(g[d].dataset.cid);if(l){var m=g[d].getElementsByClassName("tb_holder");var n={};if(0<m.length&&(m=m[0].children,m[0])){m[0].classList.contains("active_module")||(m=m[0].children);for(var p=0,r=m.length;p<r;++p){var z=b.Models.Registry.lookup(m[p].dataset.cid);if(z){var x=b.Utils.clear(z.get("mod_settings"),
!0);delete x.cid;n[p]={mod_name:z.get("mod_name"),element_id:z.get("element_id")};0<Object.keys(x).length&&(n[p].mod_settings=x);-1!==m[p].className.indexOf("module_subrow")&&(n[p]=this._getRowSettings(m[p],p,"subrow"))}}}f[d]={element_id:l.get("element_id"),column_order:d,grid_class:this.filterClass(g[d].className)};0<Object.keys(n).length&&(f[d].modules=n);x=parseFloat(g[d].style.width);0<x&&!isNaN(x)&&(f[d].grid_width=x);x=b.Utils.clear(l.get("styling"),!0);0<Object.keys(x).length&&(f[d].styling=
x)}}g={element_id:h.get("element_id"),row_order:c,cols:f,column_alignment:h.get("column_alignment"),gutter:h.get("gutter")};f={gutter:"gutter-default",column_alignment:B?"col_align_middle":"col_align_top"};c={desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_tablet_landscape:"-auto",col_tablet:"-auto",col_mobile:"-auto"};for(d in g)""!==g[d]&&null!==g[d]&&g[d]!==f[d]||delete g[d];x=b.Utils.clear(h.get("styling"),!0);for(d in c)h=e.trim(a.getAttribute("data-"+d)),void 0!==
h&&""!==h&&h!==c[d]&&(g[d]=h);0<Object.keys(x).length&&(g.styling=x)}return g},selectedGridMenu:function(a){for(var c,d,f,g,h=a.getElementsByClassName("tb_grid_menu"),k=["mobile","tablet","tablet_landscape","desktop"],l=0,m=h.length;l<m;++l)if(a=e(h[l]),c=a.data("handle"),"module"!==c){d=a.closest(".module_"+c);f=b.Models.Registry.lookup(d.data("cid"));var n=[];c=d.find("."+c+"_inner").first();var p=f.get("gutter"),r=f.get("column_alignment");g=f.get("desktop_dir");for(var z=f.get("styling"),x="",
t={},q=c[0].children,u=0,v=q.length;u<v;++u)n.push(b.Utils._getColClass(q[u].className.split(" "))),q[u].className=q[u].className.replace(/first|last/ig,""),1!==v&&(0===u?q[u].className+="rtl"===g?" last":" first":u===v-1&&(q[u].className+="rtl"===g?" first":" last"));n=a.find(".tb_grid_desktop .grid-layout-"+n.join("-"));u=n.data("col");0<n.length&&(n.parent().addClass("selected").siblings().removeClass("selected"),d.addClass("col-count-"+u),x="col-count-"+u,t["data-basecol"]=u);"ltr"!==g&&(x+=" direction-rtl");
for(u=0;4>u;++u)g=f.get(k[u]+"_dir"),"ltr"!==g&&""!==g&&(t["data-"+k[u]+"_dir"]=g,n=a.find(".tb_grid_"+k[u]+" .column-dir-"+g),n.parent().addClass("selected").siblings().removeClass("selected")),"desktop"!==k[u]&&(g=f.get("col_"+k[u]),"-auto"!==g&&""!==g&&void 0!==g&&(t["data-col_"+k[u]]=g,n=a.find(".tb_grid_"+k[u]+" .grid-layout-"+g.replace(/column|tb_3col/ig,"")),n.parent().addClass("selected").siblings().removeClass("selected")));z&&void 0!==z.row_anchor&&""!==z.row_anchor&&d.find(".tb_row_anchor").first().text(z.row_anchor);
"col_align_top"!==r&&(a.find(".column-alignment-"+r).parent().addClass("selected").siblings().removeClass("selected"),x+=" "+r);"gutter-default"!==p&&(a.find(".gutter_select").val(p),x+=" "+p);c.addClass(x).attr(t)}},clear:function(a,b,d){d=d?[]:{};for(var c in a)if(Array.isArray(a[c])){var g=this.clear(a[c],b,!0);0<g.length&&(d[c]=g)}else if("object"===typeof a[c])g=this.clear(a[c],b,!1),e.isEmptyObject(g)||(d[c]=g);else if(null!==a[c]&&void 0!==a[c]&&""!==a[c]&&"px"!==a[c]&&"pixels"!==a[c]&&"n"!==
a[c]&&"solid"!==a[c]&&"linear"!==a[c]&&"default"!==a[c]&&"|"!==a[c]&&!(-1!==c.indexOf("_gradient-css")||"cover_gradient_hover-css"===c||"background_image-css"===c||"background_image-type_gradient"===c||-1!==c.indexOf("gradient-angle")&&"180"==a[c]||-1!==c.indexOf("_padding_apply_all_padding")||-1!==c.indexOf("_margin_apply_all_margin")||-1!==c.indexOf("_border_apply_all_border")||"text_align_right"===c||"text_align_center"===c||"text_align_left"===c||"text_align_justify"===c||"show"===a[c]&&-1!==
c.indexOf("visibility_"))){if(b&&("cover_gradient_hover-gradient"===c||"background_image-gradient"===c||-1===c.indexOf("gradient-type")&&-1===c.indexOf("gradient-angle")&&-1!==c.indexOf("_gradient-gradient"))&&(g=-1!==c.indexOf("background_gradient")?c.replace("_gradient","_type").replace("-gradient",""):c.replace("-gradient","-type").replace("_gradient","_color"),"gradient"!==a[g]&&"cover_gradient"!==a[g]&&"hover_gradient"!==a[g])){g=["gradient-angle","type_image","circle-radial","gradient-type"];
for(var h=c.replace("-gradient",""),k=0,l=g.length;k<l;++k){var m=h+"-"+g[k];void 0!==a[m]&&(a[m]=d[m]=null,delete a[m],delete d[m])}continue}d[c]=a[c]}return d},builderPlupload:function(a,c){var d=e(".tb_plupload_upload_uic"+(c?"":"new_elemn"===a?".plupload-clone":""),top_iframe);if(0<d.length){var f=this;void 0===f.pconfig&&(f.pconfig=JSON.parse(JSON.stringify(themify_builder_plupload_init)),f.pconfig.multipart_params._ajax_nonce=themifyBuilder.tb_load_nonce,f.pconfig.multipart_params.topost=themifyBuilder.post_ID);
d.each(function(){var a=e(this),d=a.prop("id").replace("tb_plupload_upload_ui",""),k=e.extend(!0,{},f.pconfig),l=["browse_button","container","drop_element","file_data_name"];k.multipart_params.imgid=d;for(var m=0,n=l.length;m<n;++m)k[l[m]]=d+f.pconfig[l[m]];a.data("extensions")?k.filters[0].extensions=a.data("extensions"):k.filters[0].extensions=null!==b.activeModel?k.filters[0].extensions.replace(/\,zip|\,txt/,""):"zip,txt";d=new window.top.plupload.Uploader(k);d.init();d.bind("FilesAdded",function(a,
b){a.refresh();a.start();ThemifyBuilderCommon.showLoader("show")});d.bind("Error",function(a,b){var c=e(".prompt-box .show-error");e(".prompt-box .show-login").hide();c.show();0<c.length&&c.html('<p class="prompt-error">'+b.message+"</p>");e(".overlay, .prompt-box").fadeIn(500)});d.bind("FileUploaded",function(d,f,g){var h=JSON.parse(g.response);d=e("#tb_alert",top_iframe);g=200!==g.status||h.error?"error":"done";if(h.error)ThemifyBuilderCommon.showLoader(g),alert(h.error);else if(c){var k=e("#tb_row_wrapper").children().clone(!0);
d.promise().done(function(){b.Forms.reLoad(h,themifyBuilder.post_ID);var a=e("#tb_row_wrapper").children().clone(!0);ThemifyBuilderCommon.Lightbox.close();b.undoManager.push("","","","import",{before:k,after:a,bid:themifyBuilder.post_ID})})}else ThemifyBuilderCommon.showLoader(g),g=h.large_url?h.large_url:h.url,a.closest(".tb_input").find(".tb_uploader_input").val(g).trigger("change").parent().find(".img-placeholder").html(e("<img/>",{src:h.thumb,width:50,height:50}))});a.removeClass("plupload-clone")})}},
columnDrag:function(a,c,d,f){var g=this;c&&(c=a?a.children(".module_column"):e(".module_column"),c.css("width",""),g.setCompactMode(c));if(d&&f){a=a.children(".module_column");var h=("gutter-narrow"===d?1.6:"gutter-none"===d?0:3.2)-("gutter-narrow"===f?1.6:"gutter-none"===f?0:3.2),h=parseFloat(h*(a.length-1)/a.length);a.each(function(a){e(this).prop("style").width&&(a=parseFloat(e(this).prop("style").width)+h,e(this).css("width",a+"%"))})}else{var k={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,
"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,"col3-1":32.266,"col3-2":66.05},m={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};(a?a.children(".module_column").find(".tb_grid_drag"):e(".tb_grid_drag")).each(function(){var a,c,d,f,h=0,t,q=!1,u=0,v=!1,A,w,B,D;e(this).draggable({axis:"x",cursor:"col-resize",distance:0,scroll:!1,snap:!1,containment:".row_inner",
helper:function(b){a=e(b.currentTarget);c=a.closest(".subrow_inner");0===c.length&&(c=a.closest(".row_inner"));c.addClass("tb_drag_column_start");t=a.hasClass("tb_drag_right")?"w":"e";A="w"===t?"tb_grid_drag_right_tooltip":"tb_grid_drag_left_tooltip";v=ThemifyBuilderCommon.clone(c.closest(".module_row"));return e('<div class="ui-widget-header tb_grid_drag_tooltip '+A+'"></div><div class="ui-widget-header tb_grid_drag_tooltip"></div>')},start:function(b,e){d=c.children(".module_column");f=a.closest(".module_column");
B=c.hasClass("direction-rtl");"w"===t?(q=B?f.prev(".module_column"):f.next(".module_column"),h=a.outerWidth(),D=f.outerWidth()):(q=B?f.next(".module_column"):f.prev(".module_column"),D=h=f.outerWidth());h=parseInt(h);u=parseInt(q.outerWidth())-2;w=c.outerWidth()},stop:function(a,h){e(".tb_grid_drag_tooltip").remove();c.removeClass("tb_drag_column_start");var n=Math.ceil(100*(f.outerWidth()/w));f.css("width",n+"%");var p=k,n=3.2;c.hasClass("gutter-narrow")?(p=l,n=1.6):c.hasClass("gutter-none")&&(p=
m,n=0);var r=n*(d.length-1);d.each(function(a){a!==q.index()&&(e(this).prop("style").width?a=parseFloat(e(this).prop("style").width):(a=e.trim(g.filterClass(e(this).attr("class")).replace("first","").replace("last","")),a=p[a]),r+=a)});q.css("width",100-r+"%");q=q.add(f);g.setCompactMode(q);n=c.closest(".module_row");b.undoManager.push(n.data("cid"),v,n,"row");Themify.body.trigger("tb_grid_changed",[n])},drag:function(a,b){if(q&&0<q.length){var c=parseInt(b.position.left),c=h+("e"===t?-c:c),d=parseFloat(100*
c/w);if(5<=d&&100>d){var e=u,e=e+("w"===t?-(c-D):D-c),k=parseFloat(100*e/w);5<k&&100>k&&(q.css("width",e+"px"),f.css("width",c+"px").children("."+A).html(d.toFixed(2)+"%"),f.children(".tb_grid_drag_tooltip").last().html(k.toFixed(2)+"%"),g.setCompactMode(f))}}}})})}},grid:function(a){var b=[];a=parseInt(a);if(1===a)b.push({grid_class:"col-full"});else for(var d=0;d<a;++d)b.push({column_order:d,grid_class:"col"+a+"-1"});return[{row_order:"0",cols:b}]},setCompactMode:function(a){a instanceof jQuery&&
(a=a.get());for(var b=0,d=a.length;b<d;++b)185>a[b].clientWidth?a[b].classList.add("compact-mode"):a[b].classList.remove("compact-mode")},initNewEditor:function(a){var b=tinyMCEPreInit.mceInit.tb_lb_hidden_editor;b.elements=a;b.selector="#"+a;return this.initMCEv4(a,b)},initMCEv4:function(a,b){if(3<parseInt(tinyMCE.majorVersion)){var c=new tinyMCE.Editor(a,b,tinyMCE.EditorManager);c.render();return c}},initQuickTags:function(a){"function"===typeof window.top.QTags&&(window.top.quicktags({id:a}),window.top.QTags._buttonsInit())},
...
e(this).val());a.trigger("click")})})},datePickerLoaded:null,datePicker:function(a){function b(){var b=window.top.$.fn.themifyDatetimepicker?window.top.$.fn.themifyDatetimepicker:window.top.$.fn.datetimepicker;b&&e(".themify-datepicker",a).each(function(){var a=e(this),c=a.next(".themify-datepicker-clear");c.click(function(b){b.preventDefault();b.stopPropagation();a.val("").trigger("change");e(this).addClass("disable")}).toggleClass("disable",!a.val());b.call(a,{showButtonPanel:!0,changeYear:!0,dateFormat:a.data("dateformat")||
"yy-mm-dd",timeFormat:a.data("timeformat")||"HH:mm:ss",stepMinute:5,stepSecond:5,controlType:a.data("timecontrol")||"select",oneLine:!0,separator:a.data("timeseparator")||" ",onSelect:function(b){c.toggleClass("disable",""==b);a.trigger("change")},beforeShow:function(){e("#ui-datepicker-div",top_iframe).addClass("themify-datepicket-panel")}})})}if(null===this.datePickerLoaded){var d=this;window.top.Themify.LoadCss(themifyBuilder.meta_url+"css/jquery-ui-timepicker.min.css");window.top.Themify.LoadAsync(themifyBuilder.includes_url+
"js/jquery/ui/datepicker.min.js",function(){window.top.Themify.LoadAsync(themifyBuilder.meta_url+"js/jquery-ui-timepicker.min.js",function(){d.datePickerLoaded=!0;b()},null,null,function(){return void 0!==window.top.$.fn.themifyDatetimepicker})},null,null,function(){return void 0!==window.top.$.fn.datepicker})}else b()},_getColClass:function(a){for(var b=0,d=a.length;b<d;++b)if(-1!==this.gridClass.indexOf(a[b]))return a[b].replace("col","")},saveBuilder:function(a,c,d,f){c=c||"main";d=d||0;0===d&&
("main"===c&&b.activeModel&&e(".builder_save_button",top_iframe).trigger("click"),ThemifyBuilderCommon.showLoader("show"));var g=Object.keys(b.Instances.Builder).length,h=b.Instances.Builder[d],k=this,l=h.$el.data("postid"),h=h.toJSON();(function(a,d){d={action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:a,data:JSON.stringify(d),tb_saveto:c,sourceEditor:"visual"===b.mode?"frontend":"backend"};f&&(d.only_data=f);return e.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:d})})(l,
h).always(function(h,l){++d;g===d?(e.isFunction(a)&&a.call(k,h,l),"success"!==l?ThemifyBuilderCommon.showLoader("error"):(ThemifyBuilderCommon.showLoader("hide"),b.editing=!0,Themify.body.trigger("themify_builder_save_data",[h,l]))):setTimeout(function(){k.saveBuilder(a,c,d,f)},50)})},loadContentJs:function(a,c){ThemifyBuilderModuleJs.loadOnAjax(a,c);if(!1===b.saving){var d=e("audio.wp-audio-shortcode, video.wp-video-shortcode",a);if(0<d.length){if(themifyBuilder.media_css){for(var f in themifyBuilder.media_css)Themify.LoadCss(themifyBuilder.media_css[f]);
...
d));a.val(c);b.hasChanged=!0},onInit:function(){m.show()}};n.gradient=c?c:a.data("default-gradient")?a.data("default-gradient"):void 0;d||m.ThemifyGradient(n);g=a.prev().data("themifyGradient");c=f.find("#"+k+"-gradient-type");var p=f.find("#"+k+"-circle-radial input"),r=function(a){var b=l.closest(".gradient-angle-knob"),c=f.find("#"+k+"-circle-radial");"radial"===a?(b.hide(),b.next("span").hide(),c.show()):(b.show(),b.next("span").show(),c.hide())};d?(g.settings=e.extend({},g.settings,n),g.settings.type=
c.val(),g.settings.circle=p.is(":checked"),g.isInit=!1,g.update(),g.isInit=!0):(f.find(".themify-clear-gradient").click(function(a){a.preventDefault();h=!0;g.settings.gradient=e.ThemifyGradient["default"];g.update();h=!1}),c.change(function(a){g.setType(e(this).val());r(e(this).val())}),p.change(function(){g.setRadialCircle(e(this).is(":checked"))}),l.change(function(){var a=parseInt(e(this).val());a||(a=0);g.setAngle(a)}).knob({change:function(a){g.setAngle(Math.round(a))}}),l.removeAttr("style").parent().addClass("gradient-angle-knob").find("canvas").insertAfter(l));
r(c.val())},toRGBA:function(a){var b=a.split("_"),d=/^([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})$/;return void 0!==b[0]?(d=d.exec(b[0].replace("#","")),b=void 0!==b[1]&&"0.99"!=b[1]?b[1]:1,d?"rgba("+parseInt(d[1],16)+", "+parseInt(d[2],16)+", "+parseInt(d[3],16)+", "+b+")":a):a},getIcon:function(a){0===a.indexOf("fa-")&&(a="fa "+a);return a},getBPWidth:function(a){a=_.isArray(themifyBuilder.breakpoints[a])?themifyBuilder.breakpoints[a]:themifyBuilder.breakpoints[a].toString().split("-");return a[a.length-
1]},transitionPrefix:function(){if(void 0===this.transitionPrefix.pre){var a=document.createElement("fakeelement"),b={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"},d;for(d in b)if(void 0!==a.style[d]){this.transitionPrefix.pre=b[d];break}}return this.transitionPrefix.pre},insertModuleToolbar:function(a,b){return a.replace("\x3c!--insert--\x3e",ThemifyBuilderCommon.templateCache.get("tmpl-builder_visual_module_item").replace("\x3c!--name--\x3e",
themifyBuilder.modules[b].name))},generateUniqueID:function(){return Math.random().toString(16).substr(2,7)},getUIDList:function(a){a=a||"row";var c=_.pluck(b.Models.Registry.items,"attributes");return _.where(c,{elType:a})||[]}};_.extend(b.Views.BaseElement.prototype,b.Mixins.Common);_.extend(b.Views.Builder.prototype,b.Mixins.Builder);b.Views.ControlRegistry={items:{},register:function(a,b){this.items[a]=b},lookup:function(a){return this.items[a]||null},remove:function(a){this.items[a]=null;delete this.items[a]},
destroy:function(){_.each(this.items,function(a,b){a.remove()});this.items={}}};b.Views.Controls["default"]=Backbone.View.extend({initialize:function(a){b.Views.ControlRegistry.register(this.$el.prop("id"),this);a.binding_type&&(this.binding_type=a.binding_type);a.selector&&(this.selector=a.selector)},preview_element:function(a){if(void 0!==this.binding_type&&(b.hasChanged=!0,"module"===b.activeModel.get("elType"))){var c=this.$el.data("control-type");if(this.$el.closest(".tb_row_js_wrapper").length){var d=
this.$el.closest(".tb_row_js_wrapper");F[d.attr("id")]=b.Forms.parseSettings(d[0]).v}else F[this.$el.prop("id")]=a;"visual"===b.mode?"live"===this.binding_type?b.activeModel.trigger("custom:preview:live",F,"wp_editor"===c||"TEXTAREA"===this.el.tagName,null,this.selector,a,this.$el):"refresh"===this.binding_type&&b.activeModel.trigger("custom:preview:refresh",F,this.selector,a,this.$el):b.activeModel.backendLivePreview()}}});b.Views.Controls["default"].extend=function(a){var b=this,d=Backbone.View.extend.apply(this,
arguments);d.prototype.events=_.extend({},this.prototype.events,a.events);d.prototype.initialize=function(){_.isFunction(b.prototype.initialize)&&b.prototype.initialize.apply(this,arguments);_.isFunction(a.initialize)&&a.initialize.apply(this,arguments)};return d};b.Views.register_control=function(a,b){"default"!==a&&(this.Controls[a]=this.Controls["default"].extend(b))};b.Views.get_control=function(a){return this.control_exists(a)?this.Controls[a]:this.Controls["default"]};b.Views.control_exists=
function(a){return this.Controls.hasOwnProperty(a)};b.Views.init_control=function(a,c){c=c||{};c.binding_type||c.el.hasClass("minicolors-input")||(c.binding_type="refresh");a?"wp_editor"===a&&c.el.hasClass("data_control_binding_live")&&(c.binding_type="live"):a="change";var d=c.el.data("input-id");d||(d=c.el.prop("id"));return"wp_editor"!==a&&(d=this.ControlRegistry.lookup(d),null!==d)?(d.setElement(c.el).render(),d):new (b.Views.get_control(a))(c)};b.Views.register_control("wp_editor",{initialize:function(){this.render()},
render:function(){var a=this,c="refresh"===this.binding_type&&void 0===this.selector?1E3:50,d=this.$el.prop("id"),f=!1,g=!1,c=_.throttle(function(c){c="setupeditor"===this.type?this.getContent():e(this).val();null!==b.activeModel&&f!==c&&(f=c,!1!==g?a.$el.val(c).trigger("change"):a.preview_element(c))},c);b.Utils.initQuickTags(d);void 0!==tinyMCE&&void 0!==this.binding_type&&("undefined"!==typeof tinymce.editors[d]&&tinyMCE.execCommand("mceRemoveEditor",!0,d),d=b.Utils.initNewEditor(d),g=this.$el.hasClass("wp-editor-area")?
...
{initialize:function(){this.render()},render:function(){var a=this,b=a.$el.parent(),d=b.find(".query_category_single"),f=b.find(".query_category_multiple");d.add(f).on("change",function(b){var c=(b=e(this).hasClass("query_category_single"))?d.val()+"|single":f.val()+"|multiple";b&&f.val(e(this).val());a.preview_element(c)});return this}});b.Views.register_control("layout",{initialize:function(){this.render()},render:function(){var a=this,c=this.$el.data("input-id"),d=a.$(".tfl-icon.selected").prop("id");
c||(c=this.$el.prop("id"));this.$(".tfl-icon").click(function(f){f.preventDefault();var g=e(this);f=g.prop("id");g.addClass("selected").siblings().removeClass("selected");b.hasChanged=!0;if("visual"===b.mode)if("live"===a.binding_type&&void 0!==a.$el.data("control-selector")){var g=b.liveStylingInstance.$liveStyledElmt,h=b.liveStylingInstance.getStylingVal(c);""!==a.$el.data("control-selector")&&(g=b.liveStylingInstance.$liveStyledElmt.find(a.$el.data("control-selector")));F[c]=f;"layout_feature"===
c?(f="layout-"+f,h="layout-"+h):"columns"===c&&(f=c+"-"+f,h=c+"-"+h);!h&&d&&(h=d);g.removeClass(h).addClass(f);"layout_feature"===c?f=f.substr(7):"columns"===c&&(f=f.substr(8));b.liveStylingInstance.setStylingVal(c,f);Themify.body.trigger("builder_load_module_partial",[b.liveStylingInstance.$liveStyledElmt,b.liveStylingInstance.type])}else"row_height"===c||"row_width"===c?Themify.body.trigger("tb_row_"+c.replace("row_",""),f):a.preview_element(f)});return this}});b.Views.register_control("checkbox",
{initialize:function(){this.render()},render:function(){var a=this;this.$('input[type="checkbox"]').click(function(){if(void 0!==a.binding_type){var b=a.$('input[type="checkbox"]:checked').map(function(){return this.value}).get();a.preview_element(b.join("|"))}});return this}});b.Views.register_control("color",{is_typing:!1,initialize:function(){this.render()},render:function(){var a=this,c=this.$el.next(".color_opacity"),d=this.$el.prop("id");this.$el.minicolors({opacity:1,changeDelay:200,beforeShow:function(){var b=
ThemifyBuilderCommon.Lightbox.$lightbox,c=a.$el.closest(".minicolors"),d=c.find(".minicolors-panel");d.css("visibility","hidden").show();b.offset().left+b.width()<=d.offset().left+d.width()?c.addClass("tb_minicolors_right"):c.removeClass("tb_minicolors_right");d.css("visibility","").hide()},hide:function(){var b=a.$el.siblings(".tb_clear_btn");""!==a.$el.val()?b.show():b.hide()},change:function(f,g){f?g&&"0.99"==g?g=1:g&&0>=parseFloat(g)&&(g=0):g="";a.is_typing||c.is(":focus")||c.attr("data-opacity",
g).data("opacity",g).val(g);f&&0>=parseFloat(e(this).minicolors("opacity"))&&e(this).minicolors("opacity",0);var h=f?e(this).minicolors("rgbaString"):"";if(void 0!==a.binding_type)a.preview_element(h);else if("visual"===b.mode&&(Themify.body.trigger("themify_builder_color_picker_change",[d,a.$el,f?h:""]),-1!==d.indexOf("font_color"))){var k="";"font_color"!=d&&(k="_"+d.slice(-2));var l=ThemifyBuilderCommon.Lightbox.$lightbox,h=l.find("#font_color_type"+k+"_font_gradient_color"+k+"_gradient"),k=l.find("#font_color_type"+
k+"_font_color"+k+"_solid");k.length&&h.length&&(h.click(),k.click())}}}).minicolors("show");a.el.parentNode.insertAdjacentHTML("beforeend",'<div class="tb_clear_btn"></div>');b.Utils.createClearBtn(a.$el);c.on("blur keyup",function(b){var c=parseFloat(e.trim(e(this).val()));if(1<c||isNaN(c)||""===c||0>c)c=a.$el.val()?1:"","blur"===b.type&&e(this).val(c);e(this).attr("data-opacity",c);a.is_typing="keyup"===b.type;a.$el.minicolors("opacity",c)})}});b.Views.register_control("repeater",{events:{"click .toggle_row":"toggleField",
"click .tb_duplicate_row":"duplicateRowField","click .tb_delete_row":"deleteRowField"},initialize:function(){this.render()},render:function(){var a=this.$el,b=this,d=!1;a.sortable({items:".tb_repeatable_field",handle:".tb_repeatable_field_top",axis:"y",placeholder:"tb_state_highlight",tolerance:"pointer",cursor:"move",start:_.debounce(function(b,c){void 0!==tinyMCE&&a.find(".tb_lb_wp_editor").each(function(){var a=e(this).prop("id"),b=tinymce.get(a).getContent();e(this).data("content",b);tinyMCE.execCommand("mceRemoveEditor",
!1,a)})},300),stop:_.debounce(function(c,g){void 0!==tinyMCE&&a.find(".tb_lb_wp_editor").each(function(){var a=e(this).prop("id");tinyMCE.execCommand("mceAddEditor",!1,a);tinymce.get(a).setContent(e(this).data("content"))});d&&(g.item.removeClass("collapsed").find(".tb_repeatable_field_content").show(),d=!1);a.find(".tb_state_highlight").remove();b.preview_element()},300),sort:function(b,c){a.find(".tb_state_highlight").height(30)},beforeStart:function(a,b,c){c.item.hasClass("collapsed")||(c.item.addClass("collapsed").find(".tb_repeatable_field_content").hide(),
d=!0,b.sortable("refresh"))}});return this},toggleField:function(a){a.preventDefault();e(a.currentTarget).closest(".tb_repeatable_field").toggleClass("collapsed").find(".tb_repeatable_field_content").slideToggle()},duplicateRowField:function(a){a.preventDefault();a.stopPropagation();this.$el.next(".add_new").find("a").trigger("click",e(a.currentTarget).closest(".tb_repeatable_field"));this.preview_element()},deleteRowField:function(a){a.preventDefault();a.stopPropagation();confirm(themifyBuilder.i18n.rowDeleteConfirm)&&
(e(a.currentTarget).closest(".tb_repeatable_field").remove(),this.preview_element())}});b.Views.register_control("widget_select",{data:null,cache:[],mediaInit:null,textInit:null,initialize:function(){this.render()},search:function(){var a=this;this.$el.closest(".tb_input").find("#widgets-search").focus(this.show.bind(this)).blur(function(b){b.relatedTarget&&"available-widgets"===b.relatedTarget.id||a.hide()}).keyup(function(){a.$el.show();for(var b=e(this).val().trim(),d=new RegExp(b,"i"),f=a.el.getElementsByClassName("widget-tpl"),
g=0,h=f.length;g<h;++g)if(""===b)f[g].style.display="block";else{var k=f[g].getElementsByTagName("h3")[0],k=k.textContent||k.innerText;d.test(k)?f[g].style.display="block":f[g].style.display="none"}})},show:function(){this.$el.next(".tb_field_error_msg").remove();this.$el.parent().show()},hide:function(){this.$el.parent().hide()},select:function(a,c){var d=this,f=a.data("value"),g=a.data("idbase"),h=e("#instance_widget",ThemifyBuilderCommon.Lightbox.$lightbox),k=function(a){var k=function(){var k=
e(a.form);h.addClass("open").html(k.html());if(c)for(var l in c)k.find('[name="'+l+'"]').val(c[l]);k=null;"text"===g?wp.textWidgets&&(d.textInit||(d.textInit=!0,wp.textWidgets.init()),c&&delete wp.textWidgets.widgetControls[c["widget-id"]]):wp.mediaWidgets&&(d.mediaInit||(wp.mediaWidgets.init(),d.mediaInit=!0),c&&delete wp.mediaWidgets.widgetControls[c["widget-id"]]);e(document).trigger("widget-added",[h]);"text"===g&&b.Views.init_control("wp_editor",{el:h.find(".wp-editor-area"),binding_type:"refresh"});
c?setTimeout(function(){new SimpleBar(top_iframe.getElementById("tb_options_setting"));new SimpleBar(d.el)},100):"visual"===b.mode&&f&&h.find(":input").first().trigger("change");h.removeClass("tb_loading_widgets_form").find("select").wrap('<span class="selectwrapper"/>')},l=function(b,c){var d=b.length;(function(b,c){Themify.LoadAsync(b,c,a.v)})(b[c].src,function(){if(b[c].extra&&b[c].extra.after){var a=b[c].extra.after,e="";if("object"===typeof a)for(var f in a)a[f]&&(e+=a[f]);""!==e&&(a=document.createElement("script"),
a.type="text/javascript",a.text=e,e=document.getElementsByTagName("script")[0],e.parentNode.insertBefore(a,e))}++c;c<d?l(b,c):k()})};void 0===d.cache[g]?(a.template&&document.body.insertAdjacentHTML("beforeend",a.template),0<a.src.length?l(a.src,0):k()):k()};F.class_widget=f;h.addClass("tb_loading_widgets_form").html('<i class="fa fa-refresh fa-spin"></i>');e.ajax({type:"POST",dataType:"json",url:themifyBuilder.ajaxurl,data:{action:"module_widget_get_form",tb_load_nonce:themifyBuilder.tb_load_nonce,
load_class:f,tpl_loaded:1===d.cache[g]?1:0,id_base:g,widget_instance:c},success:function(a){a&&a.form&&(k(a),d.cache[g]=1)}})},render:function(){var a=this,c=b.activeModel.get("mod_settings"),d=a.$el.closest(".tb_input").find("#widgets-search"),f=d.prev(".tb_loading_widgets"),g=function(){function g(b,c){b.addClass("selected").siblings().removeClass("selected");a.select(b,c);a.$el.removeAttr("data-validation");d.val(b.find(".widget-title").text());a.hide();a.$el.find(".widget-tpl").show()}var h=c[a.$el.prop("id")];
a.el.insertAdjacentHTML("afterbegin",a.data);h?(h=a.$el.find('[data-value="'+h+'"]'),g(h,c.instance_widget)):new SimpleBar(a.el);a.$el.find(".widget-tpl").click(function(){g(e(this),null)});a.search();f.remove();f=null;b.hasChanged=!0};f.show();if(null===this.data){for(var h in themifyBuilder.widget_css)window.top.Themify.LoadCss(themifyBuilder.widget_css[h]);themifyBuilder.widget_css=null;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_widget_items",nonce:themifyBuilder.tb_load_nonce},
success:function(b){a.data=b;g()}})}else setTimeout(g,1);return this}});b.Views.register_control("widget_form",{initialize:function(){this.render()},render:function(){var a=this;this.$el.on("change",":input",function(){a.preview_element(a.$el.find(":input").themifySerializeObject())});return this}});b.Views.register_control("layout_part",{data:[],get:function(a){var b=this;e.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,
pid:themifyBuilder.post_ID},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(c){ThemifyBuilderCommon.showLoader("hide");b.data=c;a()},error:function(){ThemifyBuilderCommon.showLoader("error")}})},initialize:function(){this.render()},render:function(){function a(){for(var a="<option></<option>",e=b.activeModel.get("mod_settings")[c.$el.prop("id")],g=0,h=c.data.length;g<h;++g)a+="<option"+(e===c.data[g].post_name?' selected="selected"':"")+' value="'+c.data[g].post_name+
'">'+c.data[g].post_title+"</option>";c.el.insertAdjacentHTML("afterbegin",a);c.$el.change(function(){c.preview_element(this.value)})}var c=this;0===this.data.length?this.get(a):a();return this}})})(jQuery);
