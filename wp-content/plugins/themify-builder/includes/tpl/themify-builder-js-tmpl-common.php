...
<script type="text/html" id="tmpl-builder_row_item">
    ...
    <div class="tb_action_wrap tb_row_actions">
        ...
        <ul class="tb_dropdown">
            <li><div class="tb_option_row ti-settings themify-tooltip-bottom">
            ...
            <li class="tb_action_more">
                ...
                <ul>
                    ...
                    <li>
                        <div class="tb_copy_component ti-files"> <?php _e('Copy', 'themify') ?> </div>
                    </li>
                    <li>
                        <div class="tb_paste_component ti-clipboard"> <?php _e('Paste', 'themify') ?></div>
                    </li>
                    <li>
        ...
        <ul class="tb_dropdown">
            ...
            <li class="tb_action_more">
                ...
                <ul>
                    ...
                    <li>
                        <div class="tb_copy_component ti-files">
                            <?php _e('Copy', 'themify'); ?>
                        </div>
                    </li>
                    <li>
                        <div class="tb_paste_component ti-clipboard">
        ...
        <ul class="tb_dropdown">
            ...
            <li class="tb_action_more">
                ...
                <ul>
                    ...
                    <li>
                        <div class="tb_copy_component ti-files" data-component="{{ data.component_name }}">
                            <?php _e('Copy', 'themify'); ?>
                        </div>
                    </li>
                    <li>
                        <div  class="tb_paste_component ti-clipboard" data-component="{{ data.component_name }}">
                            <?php _e('Paste', 'themify'); ?>
                        </div>
                    </li> 
                </ul>
