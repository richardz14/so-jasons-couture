...
(function($){
	...
	function init_load() {
		...
		if ( $( 'span[class*="ti-"], i[class*="ti-"]' ).length && ! $( 'link[href*="themify-icons.min.css"]' ).length ) {
			$( 'head' ).append( '<link rel="stylesheet" href="' + ThemifyTiles.url + 'includes/themify/themify-icons/themify-icons.min.css" />' );
		}
		if ( $( '.fa' ).length && ! $( 'link[href*="font-awesome.min.css"]' ).length ) {
			$( 'head' ).append( '<link rel="stylesheet" href="' + ThemifyTiles.url + 'includes/themify/fontawesome/css/font-awesome.min.css" />' );
		}
		...
		if ( $( '.tile-type-gallery' ).length ) {
			if ( typeof $.fn.carouFredSel !== 'function' ) {
				scripts.push( ThemifyTiles.url + 'includes/themify/js/carousel.min.js' );
			}
		...
		if ( $( '.themify_lightbox' ).length ) {
			if ( ! $( 'link[href*="lightbox.min.css"]' ).length ) {
				$( 'head' ).append( '<link rel="stylesheet" href="' + ThemifyTiles.url + 'includes/themify/css/lightbox.min.css" />' );
			}
			if ( typeof $.fn.magnificPopup !== 'function' ) {
				scripts.push( ThemifyTiles.url + 'includes/themify/js/lightbox.min.js' );
			}
			if ( typeof ThemifyGallery === 'undefined' ) {
				window.themifyScript = ThemifyTiles.themifyScript;
				scripts.push( ThemifyTiles.url + 'includes/themify/js/themify.gallery.js' );
			}
		}
