...
class Themify_Tiles_Admin {
	...
	public function page_init() {        
		...
		add_settings_field(
			'google_maps_key', // ID
			__( 'Google Maps API Key', 'themify-tiles' ), // Title 
	...
	public function google_maps_key_callback() {
		...
		printf( '<p class="description">' . __( '<a href="https://developers.google.com/maps/documentation/javascript/get-api-key#key" target="_blank">Generate an API</a> key and insert it here.', 'themify-tiles' ) . '</p>');
	}
}
