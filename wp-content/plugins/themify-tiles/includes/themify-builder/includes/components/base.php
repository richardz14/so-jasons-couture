    ...
    protected static function get_frame_props( $selector, $id = 'top' ) {
            ...
            return array(
                    array(
                            ...
                            'selector' => $selector.'>.tb_row_frame_'.$id,
                            'option_js' => true,
                    ),
                    array(
                            'id' => $id.'-frame_layout',
                            ...
                            'options' => array(
                                    ...
                                    array('value' => 'wave3', 'label' => __('Wave 3', 'themify'), 'img' => $path . 'wave4.svg'),
                    ...
                    array(
                            ...
                            'fields' => array(
                                    array(
                                            ...
                                            'wrap_with_class' => 'tb-'.$id.'-frame_width',
                                            'units' => array(
                                                    'PX' => array(
                                                            'min' => 0,
                                                            'max' => 10000
                                    ...
                                    array(
                                            ...
                                            'wrap_with_class' => 'tb-'.$id.'-frame_height',
                                            'units' => array(
                                                    'PX' => array(
                                                            'min' => 0,
                                                            'max' => 10000
                                    ...
                                    array(
                                            ...
                                            'wrap_with_class' => 'tb-'.$id.'-frame_repeat',
                                    ),
                                ),
                            ),
                    array(
